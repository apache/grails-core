...
class GrailsConfigUtils {
     ...
     */
    static void executeGrailsBootstraps(GrailsApplication application, WebApplicationContext webContext,
        ...
        String[] beanNames = webContext.getBeanNamesForType(PersistenceContextInterceptor)
        ...
        try {
            ...
            for (GrailsClass bootstrap in bootstraps) {
    ...
    static boolean isConfigTrue(GrailsApplication application, String propertyName) {
        return application.getConfig().getProperty(propertyName, Boolean, false)
    }
