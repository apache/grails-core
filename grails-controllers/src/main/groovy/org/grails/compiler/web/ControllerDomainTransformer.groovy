...
@AstTransformer
@CompileStatic
class ControllerDomainTransformer extends AbstractGrailsArtefactTransformer {
    ...
    Class<?> getInstanceImplementation() {
        return ControllersDomainBindingApi
    }
    ...
    @Override
    void performInjection(final SourceUnit source, final GeneratorContext context, final ClassNode classNode) {
