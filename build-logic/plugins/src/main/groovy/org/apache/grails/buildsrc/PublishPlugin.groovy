...
class PublishPlugin implements Plugin<Project> {
    ...
    private static void configureGrailsPublish(Project project) {
        project.extensions.configure(GrailsPublishExtension) {
            ...
            it.title.set(project.provider { lookupProperty(project, 'pomTitle', 'Apache Grails® framework')})
            it.desc.set(project.provider { lookupProperty(project, 'pomDescription', 'Apache Grails® Web Application Framework')})
            it.organization {
