...
@CompileStatic
class BindingFormatASTTransformation implements ASTTransformation, TransformWithPriority {

    @Override
    void visit(final ASTNode[] astNodes, final SourceUnit source) {
    ...
    @Override
    int priority() {
        return GroovyTransformOrder.BINDING_FORMAT_ORDER
    }
