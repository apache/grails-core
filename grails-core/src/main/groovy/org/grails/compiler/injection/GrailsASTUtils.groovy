...
class GrailsASTUtils {
    ...
    private static final ClassNode ENHANCED_CLASS_NODE = new ClassNode(Enhanced)
    public static final ClassNode MISSING_METHOD_EXCEPTION = new ClassNode(MissingMethodException)
    ...
    public static final ClassNode INTEGER_CLASS_NODE = new ClassNode(Integer).getPlainNodeReference()
    private static final ClassNode COMPILESTATIC_CLASS_NODE = ClassHelper.make(CompileStatic)
    private static final ClassNode TYPECHECKINGMODE_CLASS_NODE = ClassHelper.make(TypeCheckingMode)
     ...
     */
    static void error(final SourceUnit sourceUnit, final ASTNode astNode, final String message) {
     ...
     */
    static void error(final SourceUnit sourceUnit, final ASTNode astNode, final String message, final boolean fatal) {
     ...
     */
    static MethodNode addDelegateInstanceMethod(ClassNode classNode, Expression delegate, MethodNode declaredMethod) {
        return addDelegateInstanceMethod(classNode, delegate, declaredMethod, null, true)
    }

    static MethodNode addDelegateInstanceMethod(ClassNode classNode, Expression delegate, MethodNode declaredMethod, AnnotationNode markerAnnotation) {
        return addDelegateInstanceMethod(classNode, delegate, declaredMethod, markerAnnotation, true)
    }

    static MethodNode addDelegateInstanceMethod(ClassNode classNode, Expression delegate, MethodNode declaredMethod, boolean thisAsFirstArgument) {
        return addDelegateInstanceMethod(classNode, delegate, declaredMethod, null, thisAsFirstArgument)
    }

    static MethodNode addDelegateInstanceMethod(ClassNode classNode, Expression delegate, MethodNode declaredMethod, AnnotationNode markerAnnotation, boolean thisAsFirstArgument) {
        return addDelegateInstanceMethod(classNode, delegate, declaredMethod, markerAnnotation, thisAsFirstArgument, null, false)
    }

    static MethodNode addDelegateInstanceMethod(ClassNode classNode, Expression delegate, MethodNode declaredMethod, AnnotationNode markerAnnotation, boolean thisAsFirstArgument, Map<String, ClassNode> genericsPlaceholders) {
     ...
     * @return The added method node or null if it couldn't be added
     */
    static MethodNode addDelegateInstanceMethod(ClassNode classNode, Expression delegate, MethodNode declaredMethod, AnnotationNode markerAnnotation, boolean thisAsFirstArgument, Map<String, ClassNode> genericsPlaceholders, boolean noNullCheck) {
     ...
     */
    static ArgumentListExpression createArgumentListFromParameters(Parameter[] parameterTypes, boolean thisAsFirstArgument, Map<String, ClassNode> genericsPlaceholders) {
        ...
        for (Parameter parameterType in parameterTypes) {
     ...
     */
    static Parameter[] getRemainingParameterTypes(Parameter[] parameters) {
     ...
     * @return The added method node or null if it couldn't be added
     */
    static MethodNode addDelegateStaticMethod(ClassNode classNode, MethodNode delegateMethod) {
     ...
     * @return The added method node or null if it couldn't be added
     */
    static MethodNode addDelegateStaticMethod(Expression expression, ClassNode classNode, MethodNode delegateMethod) {
     ...
     * @return The added method node or null if it couldn't be added
     */
    static MethodNode addDelegateStaticMethod(Expression delegate, ClassNode classNode, MethodNode delegateMethod, AnnotationNode markerAnnotation, Map<String, ClassNode> genericsPlaceholders, boolean noNullCheck) {
     ...
     */
    static ConstructorNode addDelegateConstructor(ClassNode classNode, MethodNode constructorMethod, Map<String, ClassNode> genericsPlaceholders) {
        ...
        if (constructorParams.length == 0) {
            ...
            if (constructorNode != null) {
                List<AnnotationNode> annotations = constructorNode.getAnnotations(new ClassNode(GrailsDelegatingConstructor))
            ...
            constructorNode.addAnnotation(new AnnotationNode(new ClassNode(GrailsDelegatingConstructor)))
            ...
            if (cn == null) {
                ...
                List<AnnotationNode> annotations = cn.getAnnotations(new ClassNode(GrailsDelegatingConstructor))
                if (annotations.size() == 0) {
            ...
            cn.addAnnotation(new AnnotationNode(new ClassNode(GrailsDelegatingConstructor)))
            return cn
        }
    }
     ...
     */
    static ConstructorNode findConstructor(ClassNode classNode, Parameter[] constructorParams) {
        List<ConstructorNode> declaredConstructors = classNode.getDeclaredConstructors()
        for (ConstructorNode declaredConstructor in declaredConstructors) {
    ...
    static boolean isCandidateInstanceMethod(ClassNode classNode, MethodNode declaredMethod) {
     ...
     */
    static boolean isAssignableFrom(ClassNode superClass, ClassNode childClass) {
    ...
    private static boolean implementsInterfaceInternal(ClassNode[] interfaces, String interfaceName) {
        for (ClassNode anInterface in interfaces) {
    ...
    static boolean isCandidateMethod(MethodNode declaredMethod) {
    ...
    static boolean isConstructorMethod(MethodNode declaredMethod) {
    ...
    static boolean isDomainClass(final ClassNode classNode, final SourceUnit sourceNode) {
        @SuppressWarnings('unchecked')
        ...
        if (!isDomainClass && sourceNode != null) {
            ...
            if (indexOfGrailsAppDir >= 0) {
                ...
                final String relativePathToDomainSourceFile =
                        className.replace('.'.charAt(0), File.separatorChar) + '.groovy'
    ...
    static void addDelegateInstanceMethods(ClassNode classNode, ClassNode delegateNode, Expression delegateInstance) {
        addDelegateInstanceMethods(classNode, delegateNode, delegateInstance, null)
    }

    static void addDelegateInstanceMethods(ClassNode classNode, ClassNode delegateNode, Expression delegateInstance, Map<String, ClassNode> genericsPlaceholders) {
        addDelegateInstanceMethods(classNode, classNode, delegateNode, delegateInstance, genericsPlaceholders, false, false)
    }

    static void addDelegateInstanceMethods(ClassNode supportedSuperType, ClassNode classNode, ClassNode delegateNode, Expression delegateInstance) {
        addDelegateInstanceMethods(supportedSuperType, classNode, delegateNode, delegateInstance, null, false, false)
    }

    static void addDelegateInstanceMethods(ClassNode supportedSuperType, ClassNode classNode, ClassNode delegateNode, Expression delegateInstance, Map<String, ClassNode> genericsPlaceholders, boolean noNullCheck, boolean addCompileStatic) {
        while (!delegateNode.equals(AbstractGrailsArtefactTransformer.OBJECT_CLASS)) {
            ...
            for (MethodNode declaredMethod in declaredMethods) {
    ...
    static FieldNode addFieldIfNonExistent(ClassNode classNode, ClassNode fieldType, String fieldName) {
     ...
     * @param expression The expression
     */
    static void addExpressionToAnnotationMember(AnnotationNode annotationNode, String memberName, Expression expression) {
     ...
     */
    static void addAnnotationIfNecessary(ClassNode classNode, Class<? extends Annotation> annotationClass) {
     ...
     * @param annotationClass The annotation class
     */
    static AnnotationNode addAnnotationOrGetExisting(ClassNode classNode, Class<? extends Annotation> annotationClass) {
     ...
     * @param annotationClass The annotation class
     */
    static AnnotationNode addAnnotationOrGetExisting(ClassNode classNode, Class<? extends Annotation> annotationClass, Map<String, Object> members) {
    ...
    static AnnotationNode addAnnotationOrGetExisting(ClassNode classNode, ClassNode annotationClassNode) {
        return addAnnotationOrGetExisting(classNode, annotationClassNode, Collections.emptyMap())
    }

    static AnnotationNode addAnnotationOrGetExisting(ClassNode classNode, ClassNode annotationClassNode, Map<String, Object> members) {
     ...
     * @see Enhanced
     */
    static AnnotationNode addEnhancedAnnotation(final ClassNode classNode, final String... enhancedFor) {
        ...
        if (enhancedFor != null && enhancedFor.length > 0) {
            ...
            for (final String feature in enhancedFor) {
                boolean exists = false
                for (Expression expression in featureNameExpressions) {
    ...
    private static String getGrailsVersion() {
        return GrailsASTUtils.getPackage().getImplementationVersion()
    }

    static AnnotationNode findAnnotation(ClassNode annotationClassNode, List<AnnotationNode> annotations) {
    ...
    static AnnotationNode findAnnotation(ClassNode classNode, Class<?> type) {
        List<AnnotationNode> annotations = classNode.getAnnotations()
    ...
    static boolean hasAnyAnnotations(final ClassNode classNode, final Class<? extends Annotation>... annotationsToLookFor) {
        for (Class<? extends Annotation> annotationClass in annotationsToLookFor) {
    ...
    static boolean removeAnnotation(final MethodNode methodNode, final Class<? extends Annotation> annotationClass) {
    ...
    static void addMethodIfNotPresent(ClassNode controllerClassNode, MethodNode methodNode) {
    ...
    static ExpressionStatement createPrintlnStatement(String message) {
    ...
    static ExpressionStatement createPrintlnStatement(String message, String variable) {
     ...
     */
    static void wrapMethodBodyInTryCatchDebugStatements(MethodNode methodNode) {
        ...
        tryCatchStatement.addCatch(new CatchStatement(new Parameter(new ClassNode(Throwable), 'e'), catchBlock))
    }
     ...
     */
    static Map<String, Map<String, Expression>> getConstraintMetadata(final ClosureExpression closureExpression) {
        ...
        if (closureCode instanceof BlockStatement) {
            ...
            for (final Statement closureStatement in closureStatements) {
                ...
                for (final MethodCallExpression methodCallExpression in methodExpressions) {
                    ...
                    if (objectExpression instanceof VariableExpression && 'this'.equals(((VariableExpression) objectExpression).getName())) {
                        ...
                        if (methodCallArguments instanceof TupleExpression) {
                            ...
                            if (methodCallArgumentExpressions != null && methodCallArgumentExpressions.size() == 1 && methodCallArgumentExpressions.get(0) instanceof NamedArgumentListExpression) {
                                ...
                                for (final MapEntryExpression mapEntryExpression in mapEntryExpressions) {
     ...
     * @return A map
     */
    static Map<String, ClassNode> getAssocationMap(ClassNode classNode, String associationType) {
        ...
        if (property != null && property.isStatic()) {
            ...
            if (e instanceof MapExpression) {
                ...
                for (MapEntryExpression mee in me.getMapEntryExpressions()) {
    ...
    static Map<String, ClassNode> getAllAssociationMap(ClassNode classNode) {
        Map<String, ClassNode> associationMap = new LinkedHashMap<>()
    ...
    static ClassNode findInterface(ClassNode classNode, ClassNode interfaceNode) {
    ...
    static boolean hasZeroArgsConstructor(ClassNode implementationNode) {
        List<ConstructorNode> constructors = implementationNode.getDeclaredConstructors()
        if (constructors.isEmpty()) return true
        for (ConstructorNode constructor in constructors) {
     ...
     */
    static boolean isInnerClassNode(ClassNode classNode) {
     ...
     */
    static AnnotatedNode addCompileStaticAnnotation(AnnotatedNode annotatedNode) {
     ...
     * @return The annotated method
     */
    static AnnotatedNode addCompileStaticAnnotation(AnnotatedNode annotatedNode, boolean skip) {
        if (annotatedNode != null) {
            ...
            if (!skip) {
                annotatedNode.getDeclaringClass().addTransform(StaticCompileTransformation, an)
            }
        }
     ...
     */
    static boolean addGrailsCompileStaticAnnotation(ClassNode classNode) {
        if (classNode == null || hasStaticCompilationAnnotation(classNode)) {
            return false
        }
        AnnotationNode an = new AnnotationNode(COMPILESTATIC_CLASS_NODE)
        ListExpression extensions = new ListExpression()
        for (String extension in GRAILS_COMPILE_STATIC_EXTENSIONS) {
     ...
     */
    static boolean hasStaticCompilationAnnotation(ClassNode classNode) {
        if (classNode == null) {
            return false
        }
        for (AnnotationNode annotation in classNode.getAnnotations()) {
     ...
     */
    static MethodCallExpression applyDefaultMethodTarget(final MethodCallExpression methodCallExpression, final ClassNode targetClassNode) {
     ...
     */
    static MethodCallExpression applyDefaultMethodTarget(final MethodCallExpression methodCallExpression, final Class<?> targetClass) {
     ...
     * @return The method call expression
     */
    static MethodCallExpression applyMethodTarget(final MethodCallExpression methodCallExpression, final ClassNode targetClassNode, final ClassNode... targetParameterTypes) {
        ...
        for (MethodNode method in targetClassNode.getMethods(methodName)) {
     ...
     * @return The method call expression
     */
    static MethodCallExpression applyMethodTarget(final MethodCallExpression methodCallExpression, final Class<?> targetClass, final Class<?>... targetParameterClassTypes) {
     ...
     * @return The method call expression
     */
    static MethodCallExpression applyMethodTarget(final MethodCallExpression methodCallExpression, final ClassNode targetClassNode, final Class<?>... targetParameterClassTypes) {
     ...
     * @return The method call expression
     */
    static MethodCallExpression buildPutMapExpression(final Expression objectExpression, final String keyName, final Expression valueExpression) {
        return applyDefaultMethodTarget(new MethodCallExpression(objectExpression, 'put', new ArgumentListExpression(new ConstantExpression(keyName), valueExpression)), Map)
    }
     ...
     * @return The method call expression
     */
    static MethodCallExpression buildGetMapExpression(final Expression objectExpression, final String keyName) {
        return applyDefaultMethodTarget(new MethodCallExpression(objectExpression, 'get', new ArgumentListExpression(new ConstantExpression(keyName))), Map)
    }

    static Expression buildGetThisObjectExpression(boolean inClosureBlock) {
        if (!inClosureBlock) {
            return buildThisExpression()
        } else {
            return buildGetPropertyExpression(buildThisExpression(), 'thisObject', ClassHelper.make(Closure).getPlainNodeReference())
        }
    }

    static Expression buildThisExpression() {
        return new VariableExpression('this')
    }

    static MethodCallExpression noImplicitThis(MethodCallExpression methodCallExpression) {
        return applyImplicitThis(methodCallExpression, false)
    }

    static MethodCallExpression applyImplicitThis(MethodCallExpression methodCallExpression, boolean useImplicitThis) {
    ...
    static void copyAnnotations(final AnnotatedNode from, final AnnotatedNode to, final Set<String> included, final Set<String> excluded) {
        ...
        for (final AnnotationNode node in annotationsToCopy) {
    ...
    static void filterAnnotations(final AnnotatedNode annotatedNode, final Set<String> classNamesToRetain, final Set<String> classNamesToRemove) {
    ...
    static void removeCompileStaticAnnotations(final AnnotatedNode annotatedNode) {
        filterAnnotations(annotatedNode, null, new LinkedHashSet<>(Arrays.asList([CompileStatic.getName(), TypeChecked.getName()] as String[])))
    }
    ...
    static boolean isGetterMethod(MethodNode md) {
    ...
    static boolean isSetterMethod(MethodNode md) {
        String methodName = md.getName()
    ...
    static boolean isSetterOrGetterMethod(MethodNode md) {
     ...
     */
    static URL getSourceUrl(SourceUnit source) {
        URL url = null
    ...
    static URL getSourceUrl(ClassNode classNode) {
        return getSourceUrl(classNode.getModule().getContext())
    }

    static boolean hasParameters(MethodNode methodNode) {
        return methodNode.getParameters().length > 0
    }

    static boolean isInheritedFromTrait(MethodNode methodNode) {
        return hasAnnotation(methodNode, Traits.TraitBridge)
    }
