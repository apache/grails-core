...
class TraitInjectionUtils {
    ...
    static void injectTrait(CompilationUnit unit, SourceUnit source, ClassNode classNode, Class trait) {
    ...
    private static void doInjectionInternal(CompilationUnit unit, SourceUnit source, ClassNode classNode,
        ...
        for (TraitInjector injector in injectorsToUse) {
    ...
    private static List<TraitInjector> getTraitInjectors() {
        if (traitInjectors == null) {
            traitInjectors = GrailsFactoriesLoader.loadFactories(TraitInjector)
    ...
    static void processTraitsForNode(final SourceUnit sourceUnit,
        ...
        for (final TraitInjector injector in traitInjectors) {
