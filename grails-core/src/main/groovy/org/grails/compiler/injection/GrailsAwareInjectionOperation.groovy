 ...
 */
@CompileStatic
class GrailsAwareInjectionOperation implements CompilationUnit.IPrimaryClassNodeOperation {
    ...
    static ClassInjector[] getClassInjectors() {
    ...
    static ClassInjector[] getGlobalClassInjectors() {
        if (classInjectors == null) {
            initializeState()
        }
    ...
    ClassInjector[] getLocalClassInjectors() {
    ...
    private static void initializeState() {
        ...
        ClassLoader classLoader = GrailsAwareInjectionOperation.getClassLoader()
        ...
        try {
            ...
            for (Resource resource in resources) {
                ...
                try (InputStream inputStream = resource.getInputStream()) {
                    ...
                    final String astTransformerClassName = AstTransformer.getSimpleName()
                        ...
                        AnnotationVisitor visitAnnotation(String desc, boolean visible) {
                            try {
                                if (visible && desc.contains(astTransformerClassName)) {
                                    ...
                                    if (ClassInjector.isAssignableFrom(injectorClass)) {
                                        ...
                                        if (GlobalClassInjector.isAssignableFrom(injectorClass)) {
    ...
    void call(SourceUnit source, GeneratorContext context, ClassNode classNode) throws CompilationFailedException {
        ...
        for (ClassInjector classInjector in classInjectors1) {
