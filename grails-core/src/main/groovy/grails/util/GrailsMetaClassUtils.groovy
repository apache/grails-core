...
class GrailsMetaClassUtils {
    ...
    private static final Log LOG = LogFactory.getLog(GrailsMetaClassUtils)
     ...
     * @return The registry
     */
    static MetaClassRegistry getRegistry() {
    ...
    static void copyExpandoMetaClass(Class<?> fromClass, Class<?> toClass, boolean removeSource) {
        ...
        for (Object obj in emc.getExpandoMethods()) {
        ...
        for (Object o in emc.getExpandoProperties()) {
        ...
        if (adapter == null) {
            ...
            try {
                Constructor c = adapter.getClass().getConstructor([MetaClass] as Class[])
                MetaClass newAdapter = (MetaClass) BeanUtils.instantiateClass(c, [replacement] as Object[])
    ...
    static MetaClass getMetaClass(Object instance) {
     ...
     */
    static Object getPropertyIfExists(Object instance, String property) {
        return getPropertyIfExists(instance, property, Object)
    }
    ...
    static <T> T getPropertyIfExists(Object instance, String property, Class<T> requiredType) {
     ...
     */
    static Object invokeMethodIfExists(Object instance, String methodName) {
     ...
     * @return The result of the method call or null
     */
    static Object invokeMethodIfExists(Object instance, String methodName, Object[] args) {
        MetaClass metaClass = getMetaClass(instance)
