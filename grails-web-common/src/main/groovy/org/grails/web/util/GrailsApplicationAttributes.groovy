 ...
 */
interface GrailsApplicationAttributes extends ApplicationAttributes {
    ...
    default CompositeViewResolver getCompositeViewResolver() {
        return getApplicationContext().getBean(CompositeViewResolver.BEAN_NAME, CompositeViewResolver)
    }
