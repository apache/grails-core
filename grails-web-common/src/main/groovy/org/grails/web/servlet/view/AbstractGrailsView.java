...
public abstract class AbstractGrailsView extends AbstractUrlBasedView {
     ...
     */
    protected abstract void renderTemplate(Map<String, Object> model, GrailsWebRequest webRequest, HttpServletRequest request, HttpServletResponse response) throws Exception;
