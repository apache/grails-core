 ...
 */
@CompileStatic
class GrailsWrappedRuntimeException extends GrailsException {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(GrailsWrappedRuntimeException)
            ...
            if (getLineNumber() > -1) {
                ...
                if (fileName != null) {
                    ...
                    if (gspFile == null) {
                        ...
                        GrailsApplication application = WebApplicationContextUtils.getRequiredWebApplicationContext(servletContext).getBean(GrailsApplication.APPLICATION_ID, GrailsApplication)
