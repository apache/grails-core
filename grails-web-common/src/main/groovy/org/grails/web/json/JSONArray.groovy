...
@CompileStatic
class JSONArray implements JSONElement, List {
     ...
     * @throws JSONException If there is a syntax error.
     */
    JSONArray(String string) throws JSONException {
    ...
    JSONArray put(int value) {
        put((Object) Integer.valueOf(value))
        return this
    }
    ...
    JSONArray put(int index, double value) throws JSONException {
        put(index, (Object) Double.valueOf(value))
        return this
    }
    ...
    JSONArray put(int index, int value) throws JSONException {
        put(index, (Object) Integer.valueOf(value))
        return this
    }
    ...
    JSONArray put(int index, long value) throws JSONException {
        put(index, (Object) Long.valueOf(value))
        return this
    }
