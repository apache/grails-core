...
public class DefaultControllerObservationConvention extends GrailsObservationConvention<ControllerObservationContext>
    ...
    public DefaultControllerObservationConvention() {
        super(ControllerObservationContext.class);
    }
    ...
    public String getContextualName(ControllerObservationContext context) {
        return NAME + " " + orElse(context.getController(), UNKNOWN);
    }

    @Override
    public KeyValues getLowCardinalityKeyValues(ControllerObservationContext context) {
        return KeyValues.of(
                ControllerLowCardinalityKeyNames.CONTROLLER.withValue(orElse(context.getController(), UNKNOWN)),
                ControllerLowCardinalityKeyNames.ACTION.withValue(orElse(context.getAction(), UNKNOWN)),
                error(context));
    }
