...
The Database Migration plugin helps you manage database changes while developing Grails applications. The plugin uses the https://www.liquibase.org/[Liquibase] library.
