...
* `diffTypes` - A comma-delimited list of change types to include - see https://www.liquibase.org/manual/diff#controlling_checks_since_1.8[the documentation] for what types are available
