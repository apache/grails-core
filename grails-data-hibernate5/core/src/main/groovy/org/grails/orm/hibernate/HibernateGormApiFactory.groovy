...
class HibernateGormApiFactory extends DefaultGormApiFactory {
    ...
    <D> GormStaticApi<D> createStaticApi(Class<D> persistentClass,
        ...
        return new HibernateGormStaticApi<D>(persistentClass, mappingContext, finders, resolver, qualifier, persistentClass.classLoader)
    }
    ...
    <D> GormInstanceApi<D> createInstanceApi(Class<D> persistentClass,
                                             ...
                                             boolean failOnError,
                                             boolean markDirty) {
        GormInstanceApi<D> instanceApi = new HibernateGormInstanceApi<D>(persistentClass, mappingContext, resolver, persistentClass.classLoader)
