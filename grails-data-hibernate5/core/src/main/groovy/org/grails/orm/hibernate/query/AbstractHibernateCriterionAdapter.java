...
public abstract class AbstractHibernateCriterionAdapter {
    ...
    protected static final Map<Class<?>, CriterionAdaptor<?>> CRITERION_ADAPTORS = new HashMap<Class<?>, CriterionAdaptor<?>>();
    ...
    protected void initialize() {
        ...
        synchronized (CRITERION_ADAPTORS) {
    ...
    protected void addSubqueryCriterionAdapters() {
        CRITERION_ADAPTORS.put(Query.GreaterThanAll.class, new CriterionAdaptor<Query.GreaterThanAll>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.GreaterThanEqualsAll.class, new CriterionAdaptor<Query.GreaterThanEqualsAll>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.LessThanAll.class, new CriterionAdaptor<Query.LessThanAll>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.LessThanEqualsAll.class, new CriterionAdaptor<Query.LessThanEqualsAll>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.GreaterThanSome.class, new CriterionAdaptor<Query.GreaterThanSome>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.GreaterThanEqualsSome.class, new CriterionAdaptor<Query.GreaterThanEqualsSome>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.LessThanSome.class, new CriterionAdaptor<Query.LessThanSome>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.LessThanEqualsSome.class, new CriterionAdaptor<Query.LessThanEqualsSome>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.NotIn.class, new CriterionAdaptor<Query.NotIn>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.Exists.class, new CriterionAdaptor<Query.Exists>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.NotExists.class, new CriterionAdaptor<Query.NotExists>() {
            @Override
    ...
    protected void addAssociationQueryCriterionAdapters() {
        CRITERION_ADAPTORS.put(DetachedAssociationCriteria.class, new CriterionAdaptor() {
            @Override
        ...
        CRITERION_ADAPTORS.put(AssociationQuery.class, new CriterionAdaptor() {
            @Override
            public Criterion toHibernateCriterion(AbstractHibernateQuery hibernateQuery, Query.Criterion criterion, String alias) {
    ...
    protected void addJunctionCriterionAdapters() {
        CRITERION_ADAPTORS.put(Query.Conjunction.class, new CriterionAdaptor<Query.Conjunction>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.Disjunction.class, new CriterionAdaptor<Query.Disjunction>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.Negation.class, new CriterionAdaptor<Query.Negation>() {
            @Override
            public Criterion toHibernateCriterion(AbstractHibernateQuery hibernateQuery, Query.Negation criterion, String alias) {
                CriterionAdaptor<Query.Disjunction> adapter = (CriterionAdaptor<Query.Disjunction>) CRITERION_ADAPTORS.get(Query.Disjunction.class);
    ...
    protected void addRangeQueryCriterionAdapters() {
        CRITERION_ADAPTORS.put(Query.Between.class, new CriterionAdaptor() {
            @Override
            public Criterion toHibernateCriterion(AbstractHibernateQuery hibernateQuery, Query.Criterion criterion, String alias) {
        ...
        CRITERION_ADAPTORS.put(Query.In.class, new CriterionAdaptor() {
            @Override
            public Criterion toHibernateCriterion(AbstractHibernateQuery hibernateQuery, Query.Criterion criterion, String alias) {
    ...
    protected void addLikeCriterionAdapters() {
        CRITERION_ADAPTORS.put(Query.RLike.class, new CriterionAdaptor() {
            @Override
            public Criterion toHibernateCriterion(AbstractHibernateQuery hibernateQuery, Query.Criterion criterion, String alias) {
                return createRlikeExpression(getPropertyName(criterion, alias), ((Query.RLike) criterion).getPattern());
            }
        });
        CRITERION_ADAPTORS.put(Query.Like.class, new CriterionAdaptor<Query.Like>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.ILike.class, new CriterionAdaptor<Query.ILike>() {
            @Override
    ...
    protected void addPropertyComparisonCriterionAdapters() {
        CRITERION_ADAPTORS.put(Query.EqualsProperty.class, new CriterionAdaptor<Query.EqualsProperty>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.GreaterThanProperty.class, new CriterionAdaptor<Query.GreaterThanProperty>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.GreaterThanEqualsProperty.class, new CriterionAdaptor<Query.GreaterThanEqualsProperty>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.LessThanProperty.class, new CriterionAdaptor<Query.LessThanProperty>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.LessThanEqualsProperty.class, new CriterionAdaptor<Query.LessThanEqualsProperty>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.NotEqualsProperty.class, new CriterionAdaptor<Query.NotEqualsProperty>() {
            @Override
    ...
    protected void addSimpleCriterionAdapters() {
        CRITERION_ADAPTORS.put(Query.IsNull.class, new CriterionAdaptor<Query.IsNull>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.IsNotNull.class, new CriterionAdaptor<Query.IsNotNull>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.IsEmpty.class, new CriterionAdaptor<Query.IsEmpty>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.IsNotEmpty.class, new CriterionAdaptor<Query.IsNotEmpty>() {
            @Override
    ...
    protected void addSizeComparisonCriterionAdapters() {
        CRITERION_ADAPTORS.put(Query.SizeEquals.class, new CriterionAdaptor<Query.SizeEquals>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.SizeGreaterThan.class, new CriterionAdaptor<Query.SizeGreaterThan>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.SizeGreaterThanEquals.class, new CriterionAdaptor<Query.SizeGreaterThanEquals>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.SizeLessThan.class, new CriterionAdaptor<Query.SizeLessThan>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.SizeLessThanEquals.class, new CriterionAdaptor<Query.SizeLessThanEquals>() {
            @Override
    ...
    protected void addSimplePropertyCriterionAdapters() {
        CRITERION_ADAPTORS.put(Query.IdEquals.class, new CriterionAdaptor() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.Equals.class, new CriterionAdaptor<Query.Equals>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.NotEquals.class, new CriterionAdaptor<Query.NotEquals>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.GreaterThan.class, new CriterionAdaptor<Query.GreaterThan>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.GreaterThanEquals.class, new CriterionAdaptor<Query.GreaterThanEquals>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.LessThan.class, new CriterionAdaptor<Query.LessThan>() {
            @Override
        ...
        CRITERION_ADAPTORS.put(Query.LessThanEquals.class, new CriterionAdaptor<Query.LessThanEquals>() {
            @Override
    ...
    protected void applySubCriteriaToJunction(PersistentEntity entity, AbstractHibernateQuery hibernateCriteria, List<Query.Criterion> existing,
        ...
        for (Query.Criterion subCriterion : existing) {
            ...
            CriterionAdaptor criterionAdaptor = CRITERION_ADAPTORS.get(subCriterion.getClass());
    ...
    public org.hibernate.criterion.Criterion toHibernateCriterion(AbstractHibernateQuery hibernateQuery, Query.Criterion criterion, String alias) {
        final CriterionAdaptor criterionAdaptor = CRITERION_ADAPTORS.get(criterion.getClass());
        if (criterionAdaptor != null) {
