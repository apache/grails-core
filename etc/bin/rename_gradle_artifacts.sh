...
declare -a security_mappings=(
  ...
  "org[.]grails[.]plugins:spring-security-rest-testapp-profile|org.apache.grails.profiles:spring-security-rest-testapp-profile"
...
declare -a excluded_security_mappings=(
  ...
  "exclude[[:space:]]+module[[:space:]]*:[[:space:]]*['\"]spring-security-rest-testapp-profile['\"]|exclude module:'spring-security-rest-testapp-profile'"
