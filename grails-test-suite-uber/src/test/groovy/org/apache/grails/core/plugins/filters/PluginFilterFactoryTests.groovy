...
class PluginFilterFactoryTests {
    ...
    void testExcludeFilter() {
        ...
        assertInstanceOf(ExcludingPluginFilter, bean)
    ...
    void testDefaultFilter() {
        ...
        assertInstanceOf(NoOpPluginFilter, bean)
    }
}
