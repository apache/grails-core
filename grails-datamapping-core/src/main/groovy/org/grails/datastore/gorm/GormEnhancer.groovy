...
class GormEnhancer implements Closeable {
    ...
    /**
     * Extension point for subclasses to register constraints after initialization.
     * Default implementation is no-op.
     * @deprecated Implement constraint registration outside the enhancer lifecycle.
     */
    @Deprecated
