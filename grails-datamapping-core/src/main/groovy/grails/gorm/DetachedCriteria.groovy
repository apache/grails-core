...
/**
     ...
     */
    Number deleteAll() {
        GormRegistry.instance.staticApiRegistry.findStaticApi(targetClass, connectionName).withDatastoreSession { Session session ->
            applyLazyCriteria()
    ...
    private withPopulatedQuery(Map args, Closure additionalCriteria, Closure callable)  {
        ...
        GormStaticApi staticApi = GormRegistry.instance.staticApiRegistry.findStaticApi(targetClass, connectionName)
