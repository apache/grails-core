...
class MapSecondPassBinderSpec extends HibernateGormDatastoreSpec {
    ...
    void "Test bind map second pass"() {
        ...
        when:
        collectionSecondPassBinder.bindCollectionSecondPass(booksProp, collector, persistentClasses, map)
        mapSecondPassBinder.bindMapSecondPass(booksProp, collector, persistentClasses, map)
