...
public class HibernateHqlQuery extends Query {
    ...
    public static HibernateHqlQuery createHqlQuery(
        ...
        List positionalParams = CollectionUtils.isNotEmpty(_positionalParams)  ? new ArrayList(_positionalParams) : new ArrayList();
        ...
        HibernateHqlQuery hibernateHqlQuery =  grailsHibernateTemplate.execute(session -> {
            ...
            HibernateHqlQuery hibernateHqlQuery1 = new HibernateHqlQuery(hibernateSession, persistentEntity, q);
