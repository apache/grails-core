...
public class GrailsOneToOne implements GrailsToOne {
  ...
  public GrailsOneToOne(MetadataBuildingContext buildingContext, Table table, PersistentClass owner)
  ...
  @Override
  public JdbcMapping getSelectableType(MappingContext mappingContext, int index)
      throws MappingException {
