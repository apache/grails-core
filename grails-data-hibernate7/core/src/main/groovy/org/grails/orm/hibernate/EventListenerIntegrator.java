...
public class EventListenerIntegrator implements Integrator {
  ...
  protected static final List<EventType<?>> TYPES =
      Arrays.asList(
  ...
  private <T> boolean shouldOverrideListeners(EventType<T> eventType, Object listener) {
    var isMergeListener =
        listener instanceof org.hibernate.event.internal.DefaultMergeEventListener;
    var isMergeEvent = eventType.equals(EventType.MERGE);
    var isPersistEventListener =
        listener instanceof org.hibernate.event.internal.DefaultPersistEventListener;
