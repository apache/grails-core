...
import org.apache.grails.data.hibernate5.core.GrailsDataHibernate5TckManager // Changed
...
import org.hibernate.internal.SessionFactoryImpl // Assuming compatible for H5
 ...
 */
class HibernateGormDatastoreSpec extends GrailsDataTckSpec<GrailsDataHibernate5TckManager> { // Changed
