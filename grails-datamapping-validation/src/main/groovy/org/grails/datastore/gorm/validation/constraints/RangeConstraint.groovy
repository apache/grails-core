...
class RangeConstraint extends AbstractConstraint {
    ...
    RangeConstraint(Class<?> constraintOwningClass, String constraintPropertyName, Object constraintParameter, MessageSource messageSource) {
    ...
    boolean supports(Class type) {
        return type != null && (Comparable.isAssignableFrom(type) ||
                ClassUtils.isAssignableOrConvertibleFrom(Number, type))
    }
