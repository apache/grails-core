 ...
 */
@CompileStatic
class ConstrainedPropertyBuilder extends BuilderSupport {

    private static final String SHARED_CONSTRAINT = 'shared'
    private static final String IMPORT_FROM_CONSTRAINT = 'importFrom'
    private static final Logger LOG = LoggerFactory.getLogger(ConstrainedPropertyBuilder)
    ...
    protected Object createNode(Object name, Map attributes) {
        ...
        try {
            ...
            if (constrainedProperties.containsKey(property)) {
                ...
                if (propertyType == null) {
                    if (!allowDynamic) {
                        throw new MissingMethodException(property, targetClass, [attributes] as Object[], true)
                    }
                    // assume in dynamic use types are strings
                    propertyType = CharSequence
                }
            ...
            for (Object o in attributes.keySet()) {
            ...
            throw new MissingMethodException((String) name, targetClass, [attributes] as Object[])
        }
    }
    ...
    private Object handleImportFrom(Map attributes, Class importFromClazz) {
        ...
        for (String targetPropertyName in resultingPropertyNames) {
            ...
            if (importFromConstrainedProperty != null) {
                ...
                for (Constraint importFromAppliedConstraint in importFromConstrainedProperty.getAppliedConstraints()) {
    ...
    private boolean isListOfRegexpsContainsString(List<String> listOfStrings, String stringToMatch) {
        ...
        for (String listElement in listOfStrings) {
    ...
    void setAllowDynamic(boolean allowDynamic) {
        this.allowDynamic = allowDynamic
    }

    void setDefaultNullable(boolean defaultNullable) {
