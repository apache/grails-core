...
@CompileStatic
class BeforeValidateHelper implements Serializable {
    ...
    public static final class BeforeValidateEventTriggerCaller {
        ...
        BeforeValidateEventTriggerCaller(Class<?> domainClass, MetaClass metaClass) {
            eventTriggerCaller = build(domainClass, metaClass, [List] as Class[])
            eventTriggerCallerNoArgs = build(domainClass, metaClass, new Class[0])
        }
        ...
        void call(final Object target, final List<?> validatedFieldsList) {
            if (validatedFieldsList != null && eventTriggerCaller != null) {
                eventTriggerCaller.call(target, [validatedFieldsList] as Object[])
    ...
    void invokeBeforeValidate(final Object target, final List<?> validatedFieldsList) {
