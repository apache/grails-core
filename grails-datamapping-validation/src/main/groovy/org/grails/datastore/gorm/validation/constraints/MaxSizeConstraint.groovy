...
class MaxSizeConstraint extends AbstractConstraint {
    ...
    MaxSizeConstraint(Class<?> constraintOwningClass, String constraintPropertyName, Object constraintParameter, MessageSource messageSource) {
    ...
    protected void processValidate(Object target, Object propertyValue, Errors errors) {
        ...
        if (length > maxSize) {
            Object[] args = [constraintPropertyName, constraintOwningClass, propertyValue, maxSize] as Object[]
