...
class MinSizeConstraint extends AbstractConstraint {
    ...
    MinSizeConstraint(Class<?> constraintOwningClass, String constraintPropertyName, Object constraintParameter, MessageSource messageSource) {
    ...
    protected void processValidate(Object target, Object propertyValue, Errors errors) {
        ...
        if (length < minSize) {
            Object[] args = [constraintPropertyName, constraintOwningClass, propertyValue, minSize] as Object[]
