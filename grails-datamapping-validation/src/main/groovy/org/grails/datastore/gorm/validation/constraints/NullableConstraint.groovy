...
class NullableConstraint extends AbstractVetoingConstraint {
    ...
    NullableConstraint(Class<?> constraintOwningClass, String constraintPropertyName, Object constraintParameter, MessageSource messageSource) {
    ...
    protected boolean processValidateWithVetoing(Object target, Object propertyValue, Errors errors) {
        if (propertyValue == null) {
            if (!nullable) {
                Object[] args = [constraintPropertyName, constraintOwningClass] as Object[]
