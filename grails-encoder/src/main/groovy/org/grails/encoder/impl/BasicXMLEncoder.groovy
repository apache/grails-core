 ...
 */
@CompileStatic
class BasicXMLEncoder extends AbstractCharReplacementEncoder {

    private static final String ESCAPED_APOS = xmlEscapeCharacter('\'' as char) // html doesn't have apos, so use numeric entity
    private static final String ESCAPED_QUOTE = '&quot;'
    private static final String ESCAPED_GT = '&gt;'
    private static final String ESCAPED_LT = '&lt;'
    private static final String ESCAPED_AMP = '&amp;'
    // some extras
    private static final String ESCAPED_BACKSLASH = xmlEscapeCharacter('\\' as char)
    private static final char NBSP = (char) 160
    private static final String ESCAPED_NON_BREAKING_SPACE = xmlEscapeCharacter(NBSP)
    private static final String ESCAPED_BACKTICK = xmlEscapeCharacter('`' as char)
    private static final String ESCAPED_AT = xmlEscapeCharacter('@' as char) // IE Javascript conditional compilation rules
