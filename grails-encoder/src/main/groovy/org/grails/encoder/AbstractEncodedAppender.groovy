 ...
 */
@CompileStatic
abstract class AbstractEncodedAppender implements EncodedAppender {
     ...
     */
    void append(Encoder encoder, EncodingState encodingState, CharSequence str, int off, int len)
            throws IOException {
        if (str == null || len <= 0) {
            return
        }
