...
=== Basic Querying
GORM for MongoDB supports all of the https://grails.apache.org/docs/latest/grails-data/hibernate7/manual/index.html#querying[regular methods] for executing GORM queries apart from HQL, which is a Hibernate specific query language more appropriate for SQL databases.
