 ...
 */
@CompileStatic
final class DomainServiceLocator {
    ...
    static <T extends GormEntity<T>> GormService<T> resolve(Class<T> domainClass) {
    ...
    private static <T extends GormEntity<T>> GormService<T> findService(Class<T> domainClass) {
        ...
        String[] names = ctx.getBeanNamesForType(GormService)
