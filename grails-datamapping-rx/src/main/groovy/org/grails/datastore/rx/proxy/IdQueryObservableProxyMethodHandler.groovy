...
@CompileStatic
@POJO
class IdQueryObservableProxyMethodHandler extends AbstractObservableProxyMethodHandler {

    private static final Logger LOG = LoggerFactory.getLogger(IdQueryObservableProxyMethodHandler)

    private final Query query
    protected final Observable observable
    protected Serializable proxyKey

    IdQueryObservableProxyMethodHandler(Class proxyClass, Query query, QueryState queryState, RxDatastoreClient client) {
    ...
    protected Observable resolveObservable() {
        ...
        return queryResult.map(new Func1() {
            ...
            Object call(Object o) {
                IdQueryObservableProxyMethodHandler.this.@target = o
                return o
            }
        })
    }
