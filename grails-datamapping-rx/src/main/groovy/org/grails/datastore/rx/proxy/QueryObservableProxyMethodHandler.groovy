...
@CompileStatic
@POJO
class QueryObservableProxyMethodHandler extends AbstractObservableProxyMethodHandler {
    ...
    QueryObservableProxyMethodHandler(Class proxyClass, Query query, QueryState queryState, RxDatastoreClient client) {
    ...
    protected Observable resolveObservable() {
        ...
        return queryResult.map(new Func1() {
            ...
            Object call(Object o) {
                QueryObservableProxyMethodHandler.this.@target = o
                return o
            }
        })
    }
