 ...
 */
@CompileStatic
class DefaultUrlMappingEvaluator implements UrlMappingEvaluator, ClassLoaderAware {

    private static final Logger log = LoggerFactory.getLogger(UrlMappingBuilder)
    ...
    DefaultUrlMappingEvaluator(ApplicationContext applicationContext) {
        ...
        if (applicationContext != null) {
            ...
            try {
                constraintRegistry = applicationContext.getBean(ConstraintRegistry)
            ...
            try {
                constraintEvaluator = applicationContext.getBean(ConstraintsEvaluator)
            } catch (BeansException e) {
    ...
    void setClassLoader(ClassLoader classLoader) {
        Assert.isInstanceOf(GroovyClassLoader, classLoader, 'Property [classLoader] must be an instance of GroovyClassLoader')
    ...
    static class MappingCapturingClosure extends Closure<UrlMapping> {
        ...
        MappingCapturingClosure(Script o) {
            super(o)
        }

        @Override
        UrlMapping call(Object... args) {
    ...
    class UrlMappingBuilder extends GroovyObjectSupport {
        ...
        Object getProperty(String name) {
            if (urlDefiningMode) {
                var newConstrained = new DefaultConstrainedProperty(UrlMapping, name, String, DefaultUrlMappingEvaluator.this.constraintRegistry)
        ...
        void setRedirectInfo(Object redirectInfo) {
         ...
         */
        void group(String uri, Closure<?> mappingsClosure) {
            try {
         ...
         * @since 7.1
         */
        void group(Map<String, Object> defaults, String uri, Closure<?> mappingsClosure) {
            try {
                var parentResource = new ParentResource(null, uri, true, true)
                parentResources.push(parentResource)
         ...
         */
        UrlMapping get(Map<String, String> arguments, String uri, Closure<UrlMapping> callable) {
            arguments.put(HTTP_METHOD, HttpMethod.GET.toString())
            return (UrlMapping) _invoke(uri, [arguments, callable] as Object[], this)
        }

        UrlMapping get(Map<String, String> arguments, String uri) {
            return get(arguments, uri, null)
        }

        UrlMapping get(RegexUrlMapping regexUrlMapping) {
         ...
         * @return the UrlMapping
         */
        UrlMapping post(Map<String, Object> arguments, String uri, Closure<?> callable) {
            arguments.put(HTTP_METHOD, HttpMethod.POST)
            return (UrlMapping) _invoke(uri, [arguments, callable] as Object[], this)
        }

        UrlMapping post(Map<String, Object> arguments, String uri) {
            return post(arguments, uri, null)
        }

        UrlMapping post(RegexUrlMapping regexUrlMapping) {
         ...
         * @return the UrlMapping
         */
        UrlMapping put(Map<String, Object> arguments, String uri, Closure<?> callable) {
            arguments.put(HTTP_METHOD, HttpMethod.PUT)
            return (UrlMapping) _invoke(uri, [arguments, callable] as Object[], this)
        }

        UrlMapping put(Map<String, Object> arguments, String uri) {
            return put(arguments, uri, null)
        }

        UrlMapping put(RegexUrlMapping regexUrlMapping) {
         ...
         * @return the UrlMapping
         */
        UrlMapping patch(Map<String, Object> arguments, String uri, Closure<?> callable) {
            arguments.put(HTTP_METHOD, HttpMethod.PATCH)
            return (UrlMapping) _invoke(uri, [arguments, callable] as Object[], this)
        }

        UrlMapping patch(Map<String, Object> arguments, String uri) {
            return patch(arguments, uri, null)
        }

        UrlMapping patch(RegexUrlMapping regexUrlMapping) {
         ...
         * @return the UrlMapping
         */
        UrlMapping delete(Map<String, Object> arguments, String uri, Closure<?> callable) {
            arguments.put(HTTP_METHOD, HttpMethod.DELETE)
            return (UrlMapping) _invoke(uri, [arguments, callable] as Object[], this)
        }

        UrlMapping delete(Map<String, Object> arguments, String uri) {
            return delete(arguments, uri, null)
        }

        UrlMapping delete(RegexUrlMapping regexUrlMapping) {
         ...
         * @return the UrlMapping
         */
        UrlMapping head(Map<String, Object> arguments, String uri, Closure<?> callable) {
            arguments.put(HTTP_METHOD, HttpMethod.HEAD)
            return (UrlMapping) _invoke(uri, [arguments, callable] as Object[], this)
        }

        UrlMapping head(Map<String, Object> arguments, String uri) {
            return head(arguments, uri, null)
        }

        UrlMapping head(RegexUrlMapping regexUrlMapping) {
         ...
         * @return the UrlMapping
         */
        UrlMapping options(Map<String, Object> arguments, String uri, Closure<?> callable) {
            arguments.put(HTTP_METHOD, HttpMethod.OPTIONS)
            return (UrlMapping) _invoke(uri, [arguments, callable] as Object[], this)
        }

        UrlMapping options(Map<String, Object> arguments, String uri) {
            return options(arguments, uri, null)
        }

        UrlMapping options(RegexUrlMapping regexUrlMapping) {
         ...
         */
        void collection(Closure<?> callable) {
            ...
            try {
                ...
                if (mappedURI.startsWith(SLASH) || isResponseCode) {
                    ...
                    try {
                        ...
                        args = args != null && args.length > 0 ? args : [Collections.emptyMap()] as Object[]
                        ...
                        if (args[0] instanceof Map) {
                            ...
                            if (namedArguments.containsKey(DefaultUrlMappingEvaluator.RESOURCE) || namedArguments.containsKey(DefaultUrlMappingEvaluator.SINGLE)) {
                                ...
                                if (namedArguments.containsKey(DefaultUrlMappingEvaluator.RESOURCE)) {
                                    GrailsUtil.deprecated('The ' + DefaultUrlMappingEvaluator.RESOURCE + ' syntax is deprecated and will be removed in a future release. Use ' + DefaultUrlMappingEvaluator.SINGLE + ' instead.')
                                ...
                                createSingleResourceRestfulMappings(controllerName, mappingInfo.getPlugin(), mappingInfo.getNamespace(), version, urlData, currentConstraints, calculateIncludes(namedArguments, DefaultUrlMappingEvaluator.DEFAULT_RESOURCE_INCLUDES))
                            } else if (namedArguments.containsKey(DefaultUrlMappingEvaluator.RESOURCES)) {
                                var controller = namedArguments.get(DefaultUrlMappingEvaluator.RESOURCES)
                                var isWildcard = DefaultUrlMappingEvaluator.WILDCARD_RESOURCES.equals(controller.toString())
                                if (isWildcard) {
                                ...
                                createResourceRestfulMappings(controllerName, mappingInfo.getPlugin(), mappingInfo.getNamespace(), version, urlData, currentConstraints, calculateIncludes(namedArguments, DefaultUrlMappingEvaluator.DEFAULT_RESOURCES_INCLUDES))
                            }
                            else {
                                invokeLastArgumentIfClosure(args)
                    ...
                    if (args.length > 0 && (args[0] instanceof Closure<?>)) {
                        Closure<?> callable = (Closure<?>) args[0]
                        var builder = DefaultUrlMappingEvaluator.this.constraintsEvaluator.newConstrainedPropertyBuilder(UrlMapping)
                        for (var constrainedProperty in currentConstraints) {
                    ...
                    DefaultUrlMappingEvaluator.log.error("Mapping: '{}' does not start with {} or is response code.", mappedURI, SLASH)
        ...
        protected UrlMapping createDeleteActionResourcesRestfulMapping(String controllerName, Object pluginName, Object namespace, String version, UrlMappingData urlData, List<ConstrainedProperty> constrainedList) {
            ...
            return new RegexUrlMapping(deleteUrlMappingData, controllerName, DefaultUrlMappingEvaluator.ACTION_DELETE, namespace, pluginName, null, HttpMethod.DELETE.toString(), version, deleteUrlMappingConstraints.toArray(new ConstrainedProperty[0]), grailsApplication)
        }
        ...
        protected UrlMapping createUpdatePostActionResourcesRestfulMapping(String controllerName, Object pluginName, Object namespace, String version, UrlMappingData urlData, List<ConstrainedProperty> constrainedList) {
            ...
            return new RegexUrlMapping(updateUrlMappingData, controllerName, DefaultUrlMappingEvaluator.ACTION_UPDATE, namespace, pluginName, null, HttpMethod.POST.toString(), version, updateUrlMappingConstraints.toArray(new ConstrainedProperty[0]), grailsApplication)
        }
        ...
        protected UrlMapping createUpdateActionResourcesRestfulMapping(String controllerName, Object pluginName, Object namespace, String version, UrlMappingData urlData, List<ConstrainedProperty> constrainedList) {
            var updateUrlMappingData = createRelativeUrlDataWithIdAndFormat(urlData)
            var updateUrlMappingConstraints = createConstraintsWithIdAndFormat(constrainedList)
            return new RegexUrlMapping(updateUrlMappingData, controllerName, DefaultUrlMappingEvaluator.ACTION_UPDATE, namespace, pluginName, null, HttpMethod.PUT.toString(), version, updateUrlMappingConstraints.toArray(new ConstrainedProperty[0]), grailsApplication)
        }
        ...
        protected UrlMapping createPatchActionResourcesRestfulMapping(String controllerName, Object pluginName, Object namespace, String version, UrlMappingData urlData, List<ConstrainedProperty> constrainedList) {
            ...
            return new RegexUrlMapping(patchUrlMappingData, controllerName, DefaultUrlMappingEvaluator.ACTION_PATCH, namespace, pluginName, null, HttpMethod.PATCH.toString(), version, patchUrlMappingConstraints.toArray(new ConstrainedProperty[0]), grailsApplication)
        }
        ...
        protected UrlMapping createEditActionResourcesRestfulMapping(String controllerName, Object pluginName, Object namespace, String version, UrlMappingData urlData, List<ConstrainedProperty> constrainedList) {
            ...
            editUrlMappingConstraints.add(new DefaultConstrainedProperty(UrlMapping, 'id', String, DefaultUrlMappingEvaluator.this.constraintRegistry))
            return new RegexUrlMapping(editUrlMappingData, controllerName, DefaultUrlMappingEvaluator.ACTION_EDIT, namespace, pluginName, null, HttpMethod.GET.toString(), version, editUrlMappingConstraints.toArray(new ConstrainedProperty[0]), grailsApplication)
        }
        ...
        protected UrlMapping createShowActionResourcesRestfulMapping(String controllerName, Object pluginName, Object namespace, String version, UrlMappingData urlData, List<ConstrainedProperty> constrainedList) {
            ...
            return new RegexUrlMapping(showUrlMappingData, controllerName, DefaultUrlMappingEvaluator.ACTION_SHOW, namespace, pluginName, null, HttpMethod.GET.toString(), version, showUrlMappingConstraints.toArray(new ConstrainedProperty[0]), grailsApplication)
        }
        ...
        private List<ConstrainedProperty> createConstraintsWithIdAndFormat(List<ConstrainedProperty> constrainedList) {
            ...
            showUrlMappingConstraints.add(new DefaultConstrainedProperty(UrlMapping, 'id', String, DefaultUrlMappingEvaluator.this.constraintRegistry))
            var constrainedProperty = new DefaultConstrainedProperty(UrlMapping, 'format', String, DefaultUrlMappingEvaluator.this.constraintRegistry)
        ...
        protected UrlMapping createSaveActionResourcesRestfulMapping(String controllerName, Object pluginName, Object namespace, String version, UrlMappingData urlData, List<ConstrainedProperty> constrainedList) {
            ...
            return new RegexUrlMapping(saveActionUrlMappingData, controllerName, DefaultUrlMappingEvaluator.ACTION_SAVE, namespace, pluginName, null, HttpMethod.POST.toString(), version, saveUrlMappingConstraints.toArray(new ConstrainedProperty[0]), grailsApplication)
        }
        ...
        protected UrlMapping createCreateActionResourcesRestfulMapping(String controllerName, Object pluginName, Object namespace, String version, UrlMappingData urlData, ConstrainedProperty[] constraintArray) {
            ...
            return new RegexUrlMapping(createMappingData, controllerName, DefaultUrlMappingEvaluator.ACTION_CREATE, namespace, pluginName, null, HttpMethod.GET.toString(), version, constraintArray, grailsApplication)
        }
        ...
        protected UrlMapping createIndexActionResourcesRestfulMapping(String controllerName, Object pluginName, Object namespace, String version, UrlMappingData urlData, List<ConstrainedProperty> constrainedList) {
            ...
            return new RegexUrlMapping(indexActionUrlMappingData, controllerName, DefaultUrlMappingEvaluator.ACTION_INDEX, namespace, pluginName, null, HttpMethod.GET.toString(), version, indexUrlMappingConstraints.toArray(new ConstrainedProperty[0]), grailsApplication)
        }
        ...
        protected UrlMapping createEditActionResourceRestfulMapping(String controllerName, Object pluginName, Object namespace, String version, UrlMappingData urlData, ConstrainedProperty[] constraintArray) {
            ...
            return new RegexUrlMapping(editMappingData, controllerName, DefaultUrlMappingEvaluator.ACTION_EDIT, namespace, pluginName, null, HttpMethod.GET.toString(), version, constraintArray, grailsApplication)
        }
        ...
        private UrlMapping getURLMappingForNamedArgs(Map<?, ?> namedArguments, UrlMappingData urlData, String mapping, boolean isResponseCode, List<ConstrainedProperty> constrainedList) {
            ...
            if (actionName != null && viewName != null) {
                viewName = null
                DefaultUrlMappingEvaluator.log.warn('Both [action] and [view] specified in URL mapping [{}]. The action takes precedence!', mapping)
            }
            ...
            if (isResponseCode && exceptionArg != null) {
                if (exceptionArg instanceof Class<?>) {
                    ...
                    if (Throwable.isAssignableFrom(exClass)) {
                        ((ResponseCodeUrlMapping) urlMapping).setExceptionType(exClass)
                    } else {
                        DefaultUrlMappingEvaluator.log.error('URL mapping argument [exception] with value [{}] must be a subclass of java.lang.Throwable', exceptionArg)
                    }
                } else {
                    DefaultUrlMappingEvaluator.log.error('URL mapping argument [exception] with value [{}] must be a valid class', exceptionArg)
                }
            }
        ...
        private Object getParseRequest(Map<?, ?> namedArguments, Map<?, ?> bindingVariables) {
            return getVariableFromNamedArgsOrBinding(namedArguments, bindingVariables, DefaultUrlMappingEvaluator.PARSE_REQUEST, parseRequest)
        }
        ...
        private Object getException(Map<?, ?> namedArguments, Map<?, ?> bindingVariables) {
            return getVariableFromNamedArgsOrBinding(namedArguments, bindingVariables, DefaultUrlMappingEvaluator.EXCEPTION, exception)
        }
        ...
        protected MetaMappingInfo pushNewMetaMappingInfo() {
            ...
            if (parentMappingInfo != null) {
                ...
                if (parentResource != null && !parentResource.isSingle) {
                    if (!isInCollection) {
                        mappingInfo.getConstraints().add(new DefaultConstrainedProperty(UrlMapping, parentResource.controllerName + 'Id', String, DefaultUrlMappingEvaluator.this.constraintRegistry))
                    }
                }
    ...
    class UrlGroupMappingRecursionBuilder extends UrlMappingBuilder {
        ...
        UrlGroupMappingRecursionBuilder(UrlMappingBuilder parent, ParentResource parentResource) {
            super(parent)
            this.parentResource = parentResource
        }

        @Override
        void group(String uri, Closure<?> mappings) {
        ...
        @Override
        void group(Map<String, Object> defaults, String uri, Closure<?> mappings) {
            if (parentResource != null) {
                uri = parentResource.uri.concat(uri)
            }
