...
@CompileStatic
class RegexUrlMapping extends AbstractUrlMapping {
     ...
     */
    RegexUrlMapping(UrlMappingData data, URI uri, ConstrainedProperty[] constraints, GrailsApplication grailsApplication) {
     ...
     */
    RegexUrlMapping(Object redirectInfo, UrlMappingData data, Object controllerName, Object actionName, Object namespace, Object pluginName, Object viewName, String httpMethod, String version, ConstrainedProperty[] constraints, GrailsApplication grailsApplication) {
     ...
     */
    String createURL(Map paramValues, String encoding) {
    ...
    String createURL(Map paramValues, String encoding, String fragment) {
        String url = createURL(paramValues, encoding)
        return createUrlWithFragment(url, fragment, encoding)
    }

    String createURL(String controller, String action, Map paramValues, String encoding) {
    ...
    String createURL(String controller, String action, String namespace, String pluginName, Map paramValues, String encoding) {
    ...
    String createRelativeURL(String controller, String action, Map paramValues, String encoding) {
        return createRelativeURL(controller, action, null, null, paramValues, encoding)
    }

    String createRelativeURL(String controller, String action, String pluginName, Map paramValues, String encoding) {
        return createRelativeURL(controller, action, null, pluginName, paramValues, encoding)
    }

    String createRelativeURL(String controller, String action, String namespace, String pluginName, Map paramValues, String encoding) {
        return createURLInternal(controller, action, namespace, pluginName, paramValues, encoding, false)
    }

    String createRelativeURL(String controller, String action, Map paramValues, String encoding, String fragment) {
        return createRelativeURL(controller, action, null, null, paramValues, encoding, fragment)
    }

    String createRelativeURL(String controller, String action, String namespace, String pluginName, Map paramValues,
    ...
    String createURL(String controller, String action, Map paramValues,
                            String encoding, String fragment) {
        return createURL(controller, action, null, null, paramValues, encoding, fragment)
    }

    String createURL(String controller, String action, String namespace, String pluginName, Map paramValues,
                            String encoding, String fragment) {
    ...
    private void populateParameterList(Map paramValues, String encoding, StringBuilder uri, Set usedParams) {
        ...
        for (Object o1 in paramValues.keySet()) {
    ...
    private UrlMappingInfo createUrlMappingInfo(String uri, Matcher m) {
        ...
        for (Object key in parameterValues.keySet()) {
        ...
        if (redirectInfo == null) {
            this.@redirectInfo = createRuntimeConstraintEvaluator('redirect', this.@constraints)
        }
    ...
    private int getAppliedConstraintsCount(UrlMapping mapping) {
        int count = 0
        for (Constrained prop in mapping.getConstraints()) {
