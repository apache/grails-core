 ...
 */
@CompileStatic
class GrailsControllerUrlMappings extends AbstractGrailsControllerUrlMappings {

    GrailsControllerUrlMappings(GrailsApplication grailsApplication, UrlMappings urlMappingsHolderDelegate, UrlConverter urlConverter) {
        super(grailsApplication, urlMappingsHolderDelegate, urlConverter)
    }

    GrailsControllerUrlMappings(GrailsApplication grailsApplication, UrlMappings urlMappingsHolderDelegate) {
