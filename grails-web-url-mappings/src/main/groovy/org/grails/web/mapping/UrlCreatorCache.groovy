...
class UrlCreatorCache {
    ...
    private enum CachingUrlCreatorWeigher implements Weigher<ReverseMappingKey, CachingUrlCreator> {
        ...
        @Override
        int weigh(ReverseMappingKey key, CachingUrlCreator value) {
    ...
    ReverseMappingKey createKey(String controller, String action, String namespace, String pluginName, String httpMethod, Map params) {
        return new ReverseMappingKey(controller, action, namespace, pluginName, httpMethod, params)
    }

    UrlCreator lookup(ReverseMappingKey key) {
        return cacheMap.getIfPresent(key)
    }

    UrlCreator putAndDecorate(ReverseMappingKey key, UrlCreator delegate) {
    ...
    private class CachingUrlCreator implements UrlCreator {
        ...
        String createRelativeURL(String controller, String action, Map parameterValues,
        ...
        String createRelativeURL(String controller, String action, String namespace, String pluginName, Map parameterValues,
                String encoding, String fragment) {
    ...
    static class ReverseMappingKey {
        ...
        ReverseMappingKey(String controller, String action, String namespace, String pluginName, String httpMethod, Map<Object, Object> params) {
    ...
    private static class UrlCreatorKey extends ReverseMappingKey {
        ...
        UrlCreatorKey(String controller, String action, String namespace, String pluginName, String httpMethod, Map<Object, Object> params, String encoding,
