 ...
 */
@CompileStatic
class DomainClassMarshaller extends IncludeExcludePropertyMarshaller<JSON> {
    ...
    DomainClassMarshaller(boolean includeVersion, boolean includeClass, ProxyHandler proxyHandler, GrailsApplication application) {
    ...
    private void initializeDomainClassFetchers() {
        ...
        domainClassFetchers.add(new ByGrailsApplicationDomainClassFetcher(application))
        domainClassFetchers.add(new ByDatasourceDomainClassFetcher())
    }
