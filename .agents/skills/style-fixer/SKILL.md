...
Rule file: `build/codestyle/codenarc/codenarc.groovy` (generated by the plugin under `build/codestyle/...` during setup; it may be overwritten and is not intended to be edited directly).
