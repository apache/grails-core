...
class TagOutput {
    ...
    static final Object captureTagOutput(TagLibraryLookup gspTagLibraryLookup, String namespace,
    ...
    static final GroovyObject lookupCachedTagLib(TagLibraryLookup gspTagLibraryLookup,
    ...
    static final Closure<?> createOutputCapturingClosure(Object wrappedInstance, final Object body1,
    ...
    @SuppressWarnings('rawtypes')
    static Map<String, Object> createCodecSettings(String namespace, String tagName, Map attrs,
    ...
    @SuppressWarnings('rawtypes')
    static final class ConstantClosure extends Closure {
        private static final long serialVersionUID = 1L
        private static final Class[] EMPTY_CLASS_ARR = new Class[0]
        final Object retval

        ConstantClosure(Object retval) {
            super(null)
            this.retval = retval
        }
