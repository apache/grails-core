 ...
 */
@CompileStatic
final class AstTagMethodView implements TagMethodView {
    ...
    private static final ClassNode TAG_ANNOTATION = ClassHelper.make(Tag)
    private static final ClassNode NOT_A_TAG_ANNOTATION = ClassHelper.make(NotATag)
     ...
     */
    AstTagMethodView(MethodNode method, boolean parameterNamesRetained) {
        this.method = method
