...
@CompileStatic
class EmbeddedGrailsLayoutView extends AbstractGrailsView {

    private static final Logger LOG = LoggerFactory.getLogger(EmbeddedGrailsLayoutView)
    GroovyPageLayoutFinder groovyPageLayoutFinder

    protected View innerView

    public static final String GSP_GRAILS_LAYOUT_PAGE = EmbeddedGrailsLayoutView.name + '.GSP_GRAILS_LAYOUT_PAGE'

    private ObservationRegistry observationRegistry = ObservationRegistry.NOOP

    EmbeddedGrailsLayoutView(GroovyPageLayoutFinder groovyPageLayoutFinder, View innerView) {
    ...
    protected void renderWithLayout(SpringMVCViewDecorator decorator, Content content, Map<String, Object> model,
        ...
        observation.observeChecked((Observation.CheckedRunnable) () -> decorator.render(content, model, request, response, webRequest.getServletContext()))
    }
