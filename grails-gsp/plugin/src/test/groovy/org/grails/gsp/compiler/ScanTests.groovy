...
class ScanTests {
    ...
    @Test
    void testExpressionIsTokenized() {
    ...
    @Test
    void testEscapedExpressionStaysInHtml() {
    ...
    @Test
    void testEscapedAndUnescapedExpressionsSideBySide() {
