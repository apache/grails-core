...
class ApplicationTagLibTests extends Specification implements TagLibUnitTest<ApplicationTagLib> {
    ...
    void testLinkWithMultipleCollectionParameters() {
        ...
        def template = '''<g:link controller="foo" action="action" params="[test: ['test-a', 'test-b']]'>test</g:link>'''
        expect:
        applyTemplate(template) ==
            "<a href='/test/foo/action?test=test-a&amp;test=test-b'>test</a>"
        // test caching too
        applyTemplate(template) ==
            "<a href='/test/foo/action?test=test-a&amp;test=test-b'>test</a>"
    ...
    void testLinkWithMultipleCollectionParameters2() {
        given:
        unRegisterRequestDataValueProcessor()
...
""".bytes))
    ...
    void testCreateLinkToFilesInRoot() {
        unRegisterRequestDataValueProcessor()
        def template = '''<g:resource ="/" ="test.gsp" />'''
    ...
    void testCreateLinkURLEncodingWithHTMLChars() {
        unRegisterRequestDataValueProcessor()
        def template = '''<g:createLink  action="testAction"  controller="testController" ="[email: email]" />'''
    ...
    void testCreateLinkWithBase() {
        unRegisterRequestDataValueProcessor()
        def template = '''<g:createLink ="http://www128.myhost.com:3495"  action="testAction"  controller="testController" />'''
...
//    }
    ...
    void testCreateLinkWithContextPath() {
        unRegisterRequestDataValueProcessor()
        request.contextPath = '/foo'
        def template = '''<g:createLink action action="testAction" controller controller="testController" />'''
        assertOutputEquals '/foo/testController/testAction', template
    }
    ...
    void testAbsoluteWithContextPath() {
        unRegisterRequestDataValueProcessor()
        request.contextPath = '/foo'
        def template = '''<g:createLink action action="testAction" controller controller="testController" absolute="true" />'''
        ...
        template = '''<g:createLink action action="testAction" controller controller="testController" absolute="${true}" />'''
    ...
    void testAbsoluteFalseWithContextPath() {
        unRegisterRequestDataValueProcessor()
        request.contextPath = '/foo'
        def template = '''<g:createLink action action="testAction" controller controller="testController" absolute="false" />'''

        def linkGenerator = appCtx.getBean('grailsLinkGenerator')
        linkGenerator.configuredServerBaseURL='http://www.mysite.com'
        assertOutputEquals '/foo/testController/testAction', template

        template = '''<g:createLink action action="testAction" controller controller="testController" absolute="${false}" />'''
    ...
    void testCreateLinkWithNoContextPath() {
        unRegisterRequestDataValueProcessor()
        def template = '''<g:createLink base="" action action="testAction" controller controller="testController" />'''
    ...
    void testCreateLinkWithAbsolute() {
        unRegisterRequestDataValueProcessor()
        def template = '''<g:createLink absolute="true" action action="testAction" controller controller="testController" />'''
        request.serverPort = 8080
        assertOutputEquals 'http://localhost:8080/testController/testAction', template

        template = '''<g:createLink absolute="${true}" action action="testAction" controller controller="testController" />'''
        request.serverPort = 8080
        assertOutputEquals 'http://localhost:8080/testController/testAction', template
    }
    ...
    void testCreateLinkWithAbsoluteFalse() {
        unRegisterRequestDataValueProcessor()
        def template = '''<g:createLink absolute="false" action action="testAction" controller controller="testController" />'''
        request.serverPort = 8080
        assertOutputEquals '/testController/testAction', template

        template = '''<g:createLink absolute="${false}" action action="testAction" controller controller="testController" />'''
        request.serverPort = 8080
        assertOutputEquals '/testController/testAction', template
    }
