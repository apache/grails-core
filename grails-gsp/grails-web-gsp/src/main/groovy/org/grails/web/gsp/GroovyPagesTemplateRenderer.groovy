 ...
 */
@CompileStatic
class GroovyPagesTemplateRenderer implements InitializingBean {
    ...
    void afterPropertiesSet() throws Exception {
        if (scaffoldingTemplateGenerator != null) {
            ...
            generateViewMethod = ReflectionUtils.findMethod(scaffoldingTemplateGenerator.getClass(), 'generateView', new Class<?>[]{
                GrailsDomainClass, String, Writer
            })
        }
    }
    ...
    void render(GrailsWebRequest webRequest, TemplateVariableBinding pageScope, Map<String, Object> attrs, Object body, Writer out) throws IOException {
        ...
        observation.observeChecked((Observation.CheckedRunnable) () -> doRender(templateName, webRequest, pageScope, attrs, body, out))
    }
    ...
    private Template generateScaffoldedTemplate(GrailsWebRequest webRequest, String uri) throws IOException {
        ...
        if (controllerActions != null && controllerActions.contains(webRequest.getActionName())) {
            ...
            if (domainClass != null) {
                int i = uri.lastIndexOf((int) '/'.charAt(0))
    ...
    void setScaffoldingTemplateGenerator(Object generator) {
        scaffoldingTemplateGenerator = generator
    }

    @SuppressWarnings(['rawtypes', 'unchecked'])
    void setScaffoldedActionMap(Map map) {
        scaffoldedActionMap = map
    }

    @SuppressWarnings(['unchecked', 'rawtypes'])
    void setControllerToScaffoldedDomainClassMap(Map map) {
