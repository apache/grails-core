 ...
 */
@CompileStatic
class GrailsConventionGroovyPageLocator extends DefaultGroovyPageLocator implements GrailsApplicationAware {
     ...
     */
    GroovyPageScriptSource findView(String controllerName, String viewName) {
        return findView(controllerName, viewName, lookupRequestFormat())
    }

    GroovyPageScriptSource findView(String controllerName, String viewName, String format) {
     ...
     */
    GroovyPageScriptSource findViewForFormat(String controllerName, String viewName, String format) {
    ...
    String resolveViewFormat(String viewName) {
     ...
     * @return The GroovyPageScriptSource
     */
    GroovyPageScriptSource findView(Object controller, String viewName) {
     ...
     * @return The GroovyPageScriptSource
     */
    GroovyPageScriptSource findTemplate(String controllerName, String templateName) {
     ...
     * @return The GroovyPageScriptSource
     */
    GroovyPageScriptSource findTemplate(Object controller, String templateName) {
        String controllerName = getNameForController(controller)
        GroovyPageScriptSource scriptSource = null
     ...
     * @return The GroovyPageScriptSource
     */
    GroovyPageScriptSource findView(String viewName) {
     ...
     * @return The GroovyPageScriptSource
     */
    GroovyPageScriptSource findTemplate(String templateName) {
        GrailsWebRequest webRequest = GrailsWebRequest.lookup()
        if (webRequest == null) {
     ...
     * @return The GroovyPageScriptSource
     */
    GroovyPageScriptSource findTemplateInBinding(Object controller, String templateName, TemplateVariableBinding binding) {
     ...
     * @return The GroovyPageScriptSource
     */
    GroovyPageScriptSource findTemplateInBinding(Object controller, String pluginName, String templateName, TemplateVariableBinding binding) {
        if (controller == null) {
            GrailsWebRequest webRequest = GrailsWebRequest.lookup()
            if (webRequest == null) {
     ...
     * @return The GroovyPageScriptSource
     */
    GroovyPageScriptSource findTemplateInBinding(String templateName, TemplateVariableBinding binding) {
        GrailsWebRequest webRequest = GrailsWebRequest.lookup()
        if (webRequest == null) {
     ...
     * @return The GroovyPageScriptSource
     */
    GroovyPageScriptSource findTemplateInBinding(String pluginName, String templateName, TemplateVariableBinding binding) {
        GrailsWebRequest webRequest = GrailsWebRequest.lookup()
        if (webRequest == null) {
            return findPageInBinding(pluginName, uriService.getAbsoluteTemplateURI(templateName, true), binding)
        }
     ...
     * @return The script source
     */
    GroovyPageScriptSource findTemplateByPath(String uri) {
