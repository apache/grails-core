 ...
 */
@CompileStatic
class GroovyPagesServlet extends FrameworkServlet implements PluginManagerAware {
    ...
    protected void initFrameworkServlet() throws BeansException {
        ...
        grailsAttributes = GrailsFactoriesLoader.loadFactoriesWithArguments(GrailsApplicationAttributes, Thread.currentThread().getContextClassLoader(), new Object[]{context}).get(0)
        ...
        groovyPagesTemplateEngine =
                webApplicationContext.getBean(GroovyPagesTemplateEngine.BEAN_ID, GroovyPagesTemplateEngine)
    }
