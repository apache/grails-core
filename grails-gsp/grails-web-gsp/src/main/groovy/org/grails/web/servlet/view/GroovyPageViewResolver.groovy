 ...
 */
@CompileStatic
class GroovyPageViewResolver extends InternalResourceViewResolver implements GrailsViewResolver {

    private static final Log LOG = LogFactory.getLog(GroovyPageViewResolver)
    ...
    private ObservationRegistry resolveObservationRegistry() {
        ...
        if (registry == null) {
            ...
            registry = (ctx != null) ?
                    ctx.getBeanProvider(ObservationRegistry).getIfAvailable(() -> ObservationRegistry.NOOP) :
