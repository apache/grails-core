 ...
 */
@CompileStatic
class Sitemesh3LayoutFinder implements DecoratorSelector<SiteMeshContext> {
    ...
    void setLayoutCacheExpirationMillis(long layoutCacheExpirationMillis) {
        this.layoutCacheExpirationMillis = layoutCacheExpirationMillis
    }

    @Override
    String[] selectDecoratorPaths(Content content, SiteMeshContext context) {
    ...
    private static String[] toArray(String value) {
        return value == null ? new String[0] : [value] as String[]
    }
    ...
    private String[] resolveMany(String layoutName) {
        ...
        for (String part in layoutName.split(',')) {
