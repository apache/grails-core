 ...
 */
@CompileStatic
abstract class GroovySyntaxTag implements GrailsTag {
    ...
    void init(Map context) {
        tagContext = context
        parser = (GroovyPageParser) context.get(GroovyPageParser)
    ...
    void setWriter(Writer w) {
        Assert.isInstanceOf(PrintWriter, w, 'A GroovySynax tag requires a java.io.PrintWriter instance')
        out = (PrintWriter) w
    }
    ...
    void setAttribute(String name, Object value) {
        Assert.isInstanceOf(String, value, 'A GroovySyntax tag requires only string valued attributes')
