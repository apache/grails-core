...
@CompileStatic
@POJO
class Neo4jAssociationQueryProxyHandler extends AssociationQueryProxyHandler {

    Neo4jAssociationQueryProxyHandler(Session session, AssociationQueryExecutor executor, Serializable associationKey) {
