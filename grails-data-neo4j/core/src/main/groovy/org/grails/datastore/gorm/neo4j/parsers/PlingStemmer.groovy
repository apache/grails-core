...
class PlingStemmer {
     ...
     */
    private static final Map<String, String> irregular = Collections.unmodifiableMap([
        'beefs': 'beef',
        'beeves': 'beef',
        'brethren': 'brother',
        'busses': 'bus',
     ...
     */
    static boolean isPlural(String s) {
     ...
     */
    static boolean isSingular(String s) {
     ...
     */
    static boolean isSingularAndPlural(String s) {
