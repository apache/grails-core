...
class DynamicAssociationSupport {
    ...
    private static final Logger log = LoggerFactory.getLogger(DynamicAssociationSupport)

    static Map<TypeDirectionPair, Map<String, Object>> loadDynamicAssociations(Neo4jSession session, GraphPersistentEntity graphPersistentEntity, DynamicAttributes object, Serializable id) {
        ...
        if (alreadyLoaded == null && hasDynamicAssociations) {
            ...
            final Map<String, Object> isMap = Collections.singletonMap(GormProperties.IDENTITY, (Object) id)
