 ...
 */
@CompileStatic
class Neo4jDatastore extends AbstractDatastore implements Closeable, StatelessDatastore, GraphDatastore, Settings, MultipleConnectionSourceCapableDatastore, MultiTenantCapableDatastore<Driver, Neo4jConnectionSourceSettings>, MessageSourceAware, TransactionCapableDatastore {

    private static final Logger log = LoggerFactory.getLogger(Neo4jDatastore)
     ...
     */
    Neo4jDatastore(ConnectionSources<Driver, Neo4jConnectionSourceSettings> connectionSources, Neo4jMappingContext mappingContext, ConfigurableApplicationEventPublisher eventPublisher) {
        ...
        if (!(connectionSources instanceof SingletonConnectionSources)) {
            ...
            for (ConnectionSource<Driver, Neo4jConnectionSourceSettings> connectionSource in allConnectionSources) {
                ...
                if (ConnectionSource.DEFAULT.equals(connectionSource.getName())) {
                    ...
                    childDatastore = new Neo4jDatastore(singletonConnectionSources, mappingContext, eventPublisher) {
                        @Override
                        protected GormEnhancer initialize(Neo4jConnectionSourceSettings connectionSettings) {
                            return null
                        }
                    }
                }
     ...
     */
    Neo4jDatastore(ConnectionSources<Driver, Neo4jConnectionSourceSettings> connectionSources, ConfigurableApplicationEventPublisher eventPublisher, Class... classes) {
     ...
     * @param classes The persistent classes
     */
    Neo4jDatastore(ConnectionSources<Driver, Neo4jConnectionSourceSettings> connectionSources, Class... classes) {
     ...
     * @param classes The persistent classes
     */
    Neo4jDatastore(Driver boltDriver, PropertyResolver configuration, ConfigurableApplicationEventPublisher eventPublisher, Class... classes) {
     ...
     * @param classes The persistent classes
     */
    Neo4jDatastore(Driver boltDriver, ConfigurableApplicationEventPublisher eventPublisher, Class... classes) {
     ...
     * @param classes The persistent classes
     */
    Neo4jDatastore(Driver boltDriver, PropertyResolver configuration, Class... classes) {
     ...
     * @param classes The persistent classes
     */
    Neo4jDatastore(Driver boltDriver, Class... classes) {
     ...
     * @param classes The persistent classes
     */
    Neo4jDatastore(PropertyResolver configuration, Neo4jConnectionSourceFactory connectionSourceFactory, ConfigurableApplicationEventPublisher eventPublisher, Class... classes) {
     ...
     */
    Neo4jDatastore(PropertyResolver configuration, Neo4jConnectionSourceFactory connectionSourceFactory, ConfigurableApplicationEventPublisher eventPublisher, Package... packagesToScan) {
     ...
     * @param classes The persistent classes
     */
    Neo4jDatastore(PropertyResolver configuration, ConfigurableApplicationEventPublisher eventPublisher, Class... classes) {
     ...
     * @param packagesToScan The packages to scan
     */
    Neo4jDatastore(PropertyResolver configuration, ConfigurableApplicationEventPublisher eventPublisher, Package... packagesToScan) {
     ...
     * @param classes The persistent classes
     */
    Neo4jDatastore(PropertyResolver configuration, Class... classes) {
     ...
     * @param classes The persistent classes
     */
    Neo4jDatastore(Map<String, Object> configuration, ConfigurableApplicationEventPublisher eventPublisher, Class... classes) {
     ...
     * @param classes The persistent classes
     */
    Neo4jDatastore(Map<String, Object> configuration, Class... classes) {
        this(configuration, new DefaultApplicationEventPublisher(), classes)
    }
     ...
     * @param packagesToScan The packages to scan
     */
    Neo4jDatastore(Package... packagesToScan) {
     ...
     */
    Neo4jDatastore(Package packageToScan) {
     ...
     * @param packagesToScan The packages to scan
     */
    Neo4jDatastore(PropertyResolver configuration, Package... packagesToScan) {
     ...
     * @param packagesToScan The packages to scan
     */
    Neo4jDatastore(Map<String, Object> configuration, Package... packagesToScan) {
    ...
    private static void configureValidatorRegistry(Neo4jMappingContext neo4jMappingContext, MessageSource messageSource, ValidatorRegistry defaultValidatorRegistry) {
        if (defaultValidatorRegistry instanceof ConstraintRegistry) {
            ((ConstraintRegistry) defaultValidatorRegistry).addConstraintFactory(
                new MappingContextAwareConstraintFactory(UniqueConstraint, messageSource, neo4jMappingContext)
            )
        }
    }
     ...
     */
    @Override
    Neo4jDatastoreTransactionManager getTransactionManager() {
    ...
    protected GormEnhancer initialize(Neo4jConnectionSourceSettings settings) {
        ...
        org.grails.datastore.gorm.GormRegistry.getInstance().registerApiFactory(Neo4jDatastore, new Neo4jGormApiFactory())
    ...
    void setSkipIndexSetup(boolean skipIndexSetup) {
    ...
    void setupIndexing() {
        ...
        for (PersistentEntity persistentEntity in mappingContext.getPersistentEntities()) {
            if (persistentEntity.isExternal() || Relationship.isAssignableFrom(persistentEntity.getJavaClass()))
                continue
            ...
            for (String label in graphPersistentEntity.getLabels()) {
                ...
                for (PersistentProperty persistentProperty in persistentEntity.getPersistentProperties()) {
        ...
        try {
            for (String cypher in schemaStrings) {
                if (log.isDebugEnabled()) {
    ...
    @Override
    ConnectionSources<Driver, Neo4jConnectionSourceSettings> getConnectionSources() {
    ...
    @Override
    Neo4jDatastore getDatastoreForTenantId(Serializable tenantId) {
