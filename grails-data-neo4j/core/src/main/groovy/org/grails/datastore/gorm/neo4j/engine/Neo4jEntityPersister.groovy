...
class Neo4jEntityPersister extends EntityPersister {
    ...
    private static final Logger log = LoggerFactory.getLogger(Neo4jEntityPersister)
    ...
    static long countUpdates(Result execute) {
    ...
    Object unmarshallOrFromCache(PersistentEntity defaultPersistentEntity, Map<String, Object> resultData) {
    ...
    Object unmarshallOrFromCache(PersistentEntity defaultPersistentEntity, Node data) {
        return unmarshallOrFromCache(defaultPersistentEntity, data, Collections.emptyMap())
    }

    Object unmarshallOrFromCache(PersistentEntity defaultPersistentEntity, Node data, Map<String, Object> resultData) {
        return unmarshallOrFromCache(defaultPersistentEntity, data, resultData, Collections.emptyMap())
    }

    Object unmarshallOrFromCache(PersistentEntity defaultPersistentEntity, Node data, Map<String, Object> resultData, Map<Association, Object> initializedAssociations) {
        return unmarshallOrFromCache(defaultPersistentEntity, data, resultData, initializedAssociations, LockModeType.NONE)
    }

    Object unmarshallOrFromCache(PersistentEntity defaultPersistentEntity, Node data, Map<String, Object> resultData, Map<Association, Object> initializedAssociations, LockModeType lockModeType) {
        final Neo4jSession session = getSession()
    ...
    Object unmarshallOrFromCache(PersistentEntity entity, org.neo4j.driver.types.Relationship data, Map<Association, Object> initializedAssociations, Map<Serializable, Node> initializedNodes) {
    ...
    Object unmarshallOrFromCache(PersistentEntity entity, Entity data, Map<Association, Object> initializedAssociations) {
        final Neo4jSession session = getSession()
    ...
    private PersistentEntity findDerivedPersistentEntityWithLabel(PersistentEntity parent, String label) {
        for (PersistentEntity pe in getMappingContext().getPersistentEntities()) {
    ...
    protected Object unmarshall(PersistentEntity persistentEntity, Serializable id, Entity node, Map<String, Object> resultData, Map<Association, Object> initializedAssociations) {
        ...
        for (PersistentProperty property in entityAccess.getPersistentEntity().getPersistentProperties()) {
            ...
            if ((property instanceof Simple) || (property instanceof TenantId) || (property instanceof Basic)) {
                ...
                if (resultData.containsKey(associationNodesKey)) {
                    ...
                    if (association instanceof ToOne) {
                        ...
                        Collection<Object> associationNodes
                        ...
                        if (isRelationshipEntity) {
                            ...
                            if (inverseSide instanceof ToOne) {
                                resultSet.setInitializedAssociations(Collections.singletonMap(
                                    (Association) inverseSide, entity
                                ))
                            }
                        }
        ...
        if (!nodeProperties.isEmpty()) {
            for (String nodeProperty in nodeProperties) {
    ...
    private Collection createDirtyCheckableAwareCollection(EntityAccess entityAccess, Association association, Collection delegate) {
        ...
        DirtyCheckableCollection dirtyCheckableCollection = delegate instanceof DirtyCheckableCollection ? (DirtyCheckableCollection) delegate : null
        if (!(delegate instanceof DirtyCheckableCollection)) {

            final Object entity = entityAccess.getEntity()
            if (entity instanceof DirtyCheckable) {
                final Neo4jSession session = getSession()
                for (Object o in delegate) {
            ...
            if (dirtyCheckableCollection.hasChanged()) {
                for (Object o in ((Iterable) dirtyCheckableCollection)) {
                    final EntityAccess associationAccess = getSession().createEntityAccess(association.getAssociatedEntity(), o)
    ...
    void processDynamicAssociations(GraphPersistentEntity graphEntity, EntityAccess access, Neo4jMappingContext mappingContext, Map<String, List<Object>> dynamicRelProps, List<PendingOperation<Object, Serializable>> cascadingOperations, boolean isUpdate) {
    ...
    private void persistAssociationsOfEntity(GraphPersistentEntity graphEntity, EntityAccess entityAccess, boolean isUpdate) {
        ...
        if (graphEntity.hasDynamicAssociations()) {
            ...
            for (Map.Entry<String, Object> entry : attributes.entrySet()) {
                ...
                if (value == null) {
                    ...
                    for (Object o in ((Iterable) value)) {
        ...
        for (PersistentProperty persistentProperty in graphEntity.getAssociations()) {
                ...
                if ((persistentProperty instanceof OneToMany) || (persistentProperty instanceof ManyToMany)) {
                    ...
                    if (propertyValue != null) {
                        ...
                        if (association.isBidirectional()) {
                            ...
                            for (Object associatedObject in (Iterable) propertyValue) {
