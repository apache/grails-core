...
class CypherBuilder {
    ...
    public static final String REL_VAR = 'r'
    ...
    CypherBuilder(String forLabels) {
     ...
     * @return The MATCH
     */
    static String buildRelationshipMatch(String fromLabels, String relationship, String toLabels) {
     ...
     * @return The MATCH
     */
    static String buildRelationshipMatch(String relationship) {
     ...
     * @return The MATCH
     */
    static String buildRelationship(String fromLabels, String relationship, String toLabels) {
    ...
    void addRelationshipMatch(String match) {
        if (!relationshipMatches.contains(match)) {
            relationshipMatches.add(match)
        }
    }

    void replaceFirstRelationshipMatch(String match) {
     ...
     */
    void addOptionalMatch(String match) {
    ...
    void setOrderAndLimits(String orderAndLimits) {
        this.orderAndLimits = orderAndLimits
    }

    int addParam(Object value) {
     ...
     * @param value
     */
    void replaceParamAt(int position, Object value) {
     ...
     */
    void addReturnColumn(String returnColumn) {
     ...
     */
    void addDeleteColumn(String deleteColumn) {
     ...
     */
    void addPropertySet(Map<String, Object> sets) {
        if (sets != null) {
    ...
    String build() {
        ...
        for (String r in relationshipMatches) {
            cypher.append(r)
        }
        ...
        if (!optionalMatches.isEmpty()) {
            for (String m in optionalMatches) {
