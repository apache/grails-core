 ...
 */
@CompileStatic
class DynamicToOneAssociation extends ToOne implements DynamicAssociation {

    DynamicToOneAssociation(PersistentEntity owner, MappingContext context, String name, PersistentEntity associatedType) {
