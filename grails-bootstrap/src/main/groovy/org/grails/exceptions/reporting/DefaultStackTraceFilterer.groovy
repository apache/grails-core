 ...
 */
@CompileStatic
class DefaultStackTraceFilterer implements StackTraceFilterer {
     ...
     */
    void setLogFullStackTraceOnFilter(boolean logFullStackTraceOnFilter) {
    ...
    protected boolean isApplicationClass(String className) {
        for (String packageName in packagesToFilter) {
