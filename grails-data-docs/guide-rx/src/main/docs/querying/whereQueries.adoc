...
For more information on the syntax of where queries see the https://grails.apache.org/docs/latest/grails-data/hibernate7/manual/index.html#whereQueries[relevant section in the GORM documentation].
