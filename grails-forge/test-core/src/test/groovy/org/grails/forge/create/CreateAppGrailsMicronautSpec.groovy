...
class CreateAppGrailsMicronautSpec extends CommandSpec {
    ...
    void "test basic create-app build task with grails-micronaut feature"() {
        given:
    ...
    void "test gradle.properties and build.gradle with micronaut feature"() {
        given:
        generateProject(OperatingSystem.MACOS_ARCH64, ['grails-micronaut'], ApplicationType.WEB)
