...
class SpringIOUtils {
    ...
    static String computeChecksum(File f, String algorithm) throws IOException {
     ...
     */
    static int copy(File in, File out) throws IOException {
     ...
     * @throws java.io.IOException in case of I/O errors
     */
    static int copy(Resource in, File out) throws IOException {
        assert in != null : 'No input File specified'
        assert out != null : 'No output File specified'
     ...
     */
    static void copy(byte[] in, File out) throws IOException {
     ...
     * @throws IOException in case of I/O errors
     */
    static byte[] copyToByteArray(File in) throws IOException {
        assert in != null : 'No input File specified'
     ...
     * @throws IOException in case of I/O errors
     */
    static void copy(byte[] in, OutputStream out) throws IOException {
        assert in != null : 'No input byte array specified'
        assert out != null : 'No output stream specified'
        try {
            out.write(in)
     ...
     * @throws IOException in case of I/O errors
     */
    static int copy(Reader in, Writer out) throws IOException {
     ...
     * @throws IOException in case of I/O errors
     */
    static void copy(String in, Writer out) throws IOException {
     ...
     * @since 8.0.0
     */
    static XmlSlurper createXmlSlurper(boolean allowDocTypeDeclaration) throws ParserConfigurationException, SAXException {
     ...
     * @since 8.0.0
     */
    static SAXParser newSAXParser(boolean allowDocTypeDeclaration) throws ParserConfigurationException, SAXException {
    ...
    private static SAXParserFactory buildParserFactory(boolean allowDocTypeDeclaration) throws ParserConfigurationException {
        ...
        setFeature(factory, XmlParserFeature.DISALLOW_DOCTYPE_DECL.featureName, !allowDocTypeDeclaration)
        for (XmlParserFeature feature : DISABLED_PARSER_FEATURES) {
            setFeature(factory, feature.featureName, false)
        }
        return factory
    }
    ...
    private static void setFeature(SAXParserFactory factory, String name, boolean value) {
        try {
            ...
            LoggerFactory.getLogger(SpringIOUtils).warn(
