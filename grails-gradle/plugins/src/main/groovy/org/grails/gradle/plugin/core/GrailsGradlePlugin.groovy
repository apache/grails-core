...
class GrailsGradlePlugin implements Plugin<Project> {
    ...
    private void configureGroovyCompiler(Project project) {
        project.tasks.withType(GroovyCompile).configureEach { GroovyCompile c ->
            ...
            // Publish the grails { compileStaticControllers / compileStaticServices } opt-ins to the
            ...
            GrailsExtension grailsCompileStatic = project.extensions.findByType(GrailsExtension)
            if (grailsCompileStatic != null) {
                c.groovyOptions.forkOptions.jvmArgumentProviders.add(new GrailsCompileStaticArtefactsProvider(grailsCompileStatic))
            }
