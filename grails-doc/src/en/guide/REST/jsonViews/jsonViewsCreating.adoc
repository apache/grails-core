...
There is an implicit `json` variable which is an instance of https://docs.groovy-lang.org/latest/html/api/groovy/json/StreamingJsonBuilder.html[StreamingJsonBuilder].
...
Refer to the API documentation on https://docs.groovy-lang.org/latest/html/api/groovy/json/StreamingJsonBuilder.html[StreamingJsonBuilder] for more information about what is possible.
