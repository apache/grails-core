...
If you use a database other than H2 you need a JDBC driver. For example for MySQL you would need https://www.mysql.com/downloads/connector/j/[Connector/J].
