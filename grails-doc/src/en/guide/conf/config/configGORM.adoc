...
NOTE: GORM for Hibernate runs on Hibernate 7.4. If you are moving an application from Hibernate 5, see the link:upgrading.html#_hibernate_5_to_hibernate_7_migration[Hibernate 5 to Hibernate 7 Migration] guide for the full list of differences and workarounds.
