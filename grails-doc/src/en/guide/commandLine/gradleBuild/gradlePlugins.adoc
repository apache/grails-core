...
* `org.apache.grails.gradle.grails-app` - The main Grails gradle plugin implementation
...
* `org.apache.grails.gradle.grails-gson` - Adds support for compiling Groovy Json Views (GSON)
* `org.apache.grails.gradle.grails-markup` - Adds support for compiling Markup Views
* `org.apache.grails.gradle.grails-plugin` - Adds support Grails plugins
* `org.apache.grails.gradle.grails-web` - Adds web specific extensions
* `org.apache.grails.gradle.grails-publish` - Adds support for publishing Grails related artifacts
* `org.apache.grails.gradle.grails-profile` - Adds support for compiling a Grails profile into a JAR file for distribution
* `org.apache.grails.gradle.grails-publish-profile` - Adds support for publishing profiles