...
// NEW: The following commands use the Forge CLI, which supports profile-based application generation.
// NEW: Updated to use Forge CLI
[source,console]
----
$ grails -t forge create-app myapp --profile mycompany
----
...
[source,console]
----
$ grails -t forge create-app myapp --profile com.mycompany:mycompany:1.0.1
----
