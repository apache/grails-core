...
* A https://github.com/textmate/groovy-grails.tmbundle[bundle] is available for Groovy / Grails support in https://macromates.com[Textmate].
* A https://packagecontrol.io/packages/Grails[plugin] can be installed via Sublime Package Control for the https://www.sublimetext.com[Sublime Text Editor].
* The https://github.com/lifeisfoo/emacs-grails[emacs-grails] extension offers basic support for Grails development in Emacs.
* See https://www.objectpartners.com/2012/02/21/using-vim-as-your-grails-ide-part-1-navigating-your-project/[this post] for some helpful tips on how to set up VIM as your Grails editor of choice.
