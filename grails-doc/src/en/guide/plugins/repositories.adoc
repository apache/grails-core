...
NOTE: If you have created a Grails plugin and want it to be hosted in the central repository, you'll find instructions for getting an account on the https://plugins.grails.org/[plugin portal] website.
