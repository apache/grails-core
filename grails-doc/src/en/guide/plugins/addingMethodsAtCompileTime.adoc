...
As an alternative to using the `@Enhances` annotation above, you can implement a link:{api}grails/compiler/traits/TraitInjector.html[TraitInjector] to tell Grails which artefacts you want to inject the trait into at compile time:
