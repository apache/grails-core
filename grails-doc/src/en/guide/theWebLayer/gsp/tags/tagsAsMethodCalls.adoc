...
One major different between GSP tags and other tagging technologies is that GSP tags can be called as either regular tags or as method calls from link:#controllers[controllers], link:#taglibs[tag libraries] or GSP views.
