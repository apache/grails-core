...
The GPars module remains available for compatibility, but new applications should prefer the core promise factories or the virtual-thread opt-in while GPars support is prepared for deprecation.
