...
A Grails banner was introduced in Grails 7 that is displayed on application startup.
...
Grails 7.1 introduces a new `grails-testing-support-httpclient` module that simplifies HTTP-based
integration and functional tests.

The module provides `HttpClientSupport` for JDK `HttpClient` request helpers (GET/POST/PUT/PATCH/DELETE),
request and client builders, and fluent response assertions.
