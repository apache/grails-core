...
Grails 9 turns invokedynamic back on by default. You do not need to set `grails { indy = true }`.
That matches Groovy 6's preferred dispatch and is the mode CI already exercises on the Groovy 6 line.
