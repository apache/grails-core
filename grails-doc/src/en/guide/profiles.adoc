...
By default, Grails will resolve profiles from the https://repository.apache.org/content/groups/snapshots/org/apache/grails/profiles/[Apache Snapshot Repository] or https://repo1.maven.org/maven2/org/apache/grails/profiles/[Maven central repository]. However, you can override what repositories will be searched by specifying repositories in the `USER_HOME/.grails/settings.groovy` file.
