...
// NEW: Use the correct CLI invocation
[source,console]
----
...
[source,console]
----
$ grails -t forge create-app myapp --profile=rest-api
----
...
// NEW: The following commands use the Forge CLI to create applications with profiles.
// Forge must be explicitly invoked using `-t forge` when using `--profile`, `--jdk`, `--features`, etc.
[source,console]
----
$ grails -t forge create-app myapp --profile=com.mycompany.grails.profiles:myprofile:1.0.0
----
...
[source,console]
----
$ grails -t forge create-app myapp --profile=myprofile
----
