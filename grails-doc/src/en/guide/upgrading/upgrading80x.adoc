...
==== 2. Spring Boot Autoconfigure Modularization
...
==== 3. MongoDB Configuration Property Changes
...
==== 4. Hibernate ORM Package Relocations
...
==== 5. HttpStatus.MOVED_TEMPORARILY Removed
...
==== 6. Micronaut Integration - CLASSIC Boot Loader Removed
...
==== 7. Enum Serialization Default Changed
...
==== 9. Embedded Server Module Relocations
...
==== 10. HandlerAdapter.getLastModified Removed
...
==== 11. Spring Security Filter Ordering
...
==== 12. Known Plugin Incompatibilities
