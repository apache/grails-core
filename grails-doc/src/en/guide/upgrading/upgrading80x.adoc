...
==== 24. Apache Groovy 5 Behavior Changes
...
===== 24.1 Assigning a static field from a static closure requires the class name
...
===== 24.2 Probing a `ConfigObject` for a missing key
