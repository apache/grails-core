...
- the `checkForChangesExpected` on GrailsPlugin was previously deprecated and is now removed.
- `GrailsClassUtils#isGetter(String, Class[])` was previously deprecated and is now removed.  Use `isGetter(String, Class, Class[])` instead.
- `GrailsClassUtils#getPropertyForGetter(String)` was previously deprecated and is now removed.  Use `getPropertyForGetter(String, Class)` instead.
- `AbstractGrailsClass#getPropertyDescriptors` was previously deprecated and is now removed. Use `getMetaProperties` instead.
