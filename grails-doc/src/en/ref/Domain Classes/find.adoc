...
The `find` method allows querying with Hibernate's query language  link:{hibernate7GuideFromRef}index.html#hql[HQL] and querying by example. The basic syntax is:
