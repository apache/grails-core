...
Equivalent to the Hibernate https://javadoc.io/doc/org.hibernate.orm/hibernate-core/{hibernate7Version}/org/hibernate/Session.html#refresh-java.lang.Object-[refresh] method.
