...
@CompileStatic
class DocumentMappingContext extends AbstractMappingContext {
    ...
    DocumentMappingContext(String defaultDatabaseName, ConnectionSourceSettings settings) {
        super(settings)
    ...
    @Deprecated
    DocumentMappingContext(String defaultDatabaseName) {
        Assert.notNull(defaultDatabaseName, 'Argument [defaultDatabaseName] cannot be null')
        this.defaultDatabaseName = defaultDatabaseName
    ...
    @Deprecated
    DocumentMappingContext(String defaultDatabaseName, Closure defaultMapping) {
        Assert.notNull(defaultDatabaseName, 'Argument [defaultDatabaseName] cannot be null')
    ...
    @Override
    MappingFactory<Collection, Attribute> getMappingFactory() {
