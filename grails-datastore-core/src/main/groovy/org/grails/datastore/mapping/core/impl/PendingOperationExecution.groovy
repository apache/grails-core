...
@CompileStatic
class PendingOperationExecution {

    static void executePendingOperation(PendingOperation pendingOperation) {
        ...
        if (!pendingOperation.isVetoed()) {
            ...
            for (PendingOperation cascadeOperation in cascadeOperations) {
