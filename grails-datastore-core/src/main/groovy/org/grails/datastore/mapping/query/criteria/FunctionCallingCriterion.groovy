 ...
 */
@CompileStatic
class FunctionCallingCriterion extends PropertyNameCriterion {

    private String functionName
    private PropertyCriterion propertyCriterion
    private boolean onValue

    FunctionCallingCriterion(String functionName, PropertyCriterion propertyCriterion) {
        super(propertyCriterion.getProperty())
        this.functionName = functionName
        this.propertyCriterion = propertyCriterion
    }

    FunctionCallingCriterion(String name, String functionName, PropertyCriterion propertyCriterion, boolean onValue) {
        super(name)
        this.functionName = functionName
        this.propertyCriterion = propertyCriterion
