...
@CompileStatic
@POJO
abstract class EntityProxyMethodHandler extends GroovyObjectMethodHandler {
    ...
    EntityProxyMethodHandler(Class<?> proxyClass) {
        super(proxyClass)
    }
    ...
    @Override
    Object invokeMethodBeforeResolving(Object self, String methodName, Object[] args) {
