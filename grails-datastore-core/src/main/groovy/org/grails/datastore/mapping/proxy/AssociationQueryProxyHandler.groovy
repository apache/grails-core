...
@CompileStatic
@POJO
class AssociationQueryProxyHandler extends EntityProxyMethodHandler {
    ...
    AssociationQueryProxyHandler(Session session, AssociationQueryExecutor executor, Serializable associationKey) {
