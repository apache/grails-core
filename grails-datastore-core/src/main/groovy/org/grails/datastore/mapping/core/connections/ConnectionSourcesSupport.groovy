 ...
 */
@CompileStatic
class ConnectionSourcesSupport {
     ...
     */
    static String getDefaultConnectionSourceName(PersistentEntity entity) {
     ...
     */
    static List<String> getConnectionSourceNames(PersistentEntity entity) {
     ...
     */
    static boolean usesConnectionSource(PersistentEntity entity, String connectionSourceName) {
    ...
    protected static boolean isMultiTenant(Class[] interfaces) {
        for (Class anInterface in interfaces) {
    ...
    protected static boolean isMultiTenantExcludedDataSource(PersistentEntity entity, String connectionSourceName) {
        TenantDataSourceConfig tdsc = (TenantDataSourceConfig) entity.getJavaClass().getAnnotation(TenantDataSourceConfig)
