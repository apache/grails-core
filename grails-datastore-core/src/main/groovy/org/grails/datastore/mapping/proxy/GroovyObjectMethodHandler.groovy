...
@CompileStatic
@POJO
class GroovyObjectMethodHandler implements MethodHandler {
    ...
    GroovyObjectMethodHandler(Class<?> proxyClass) {
        this.proxyClass = proxyClass
    }

    Object getProperty(Object self, String property) {
    ...
    void setProperty(Object self, String property, Object newValue) {
    ...
    Object invokeThisMethod(Object self, String name, Object[] args) {
    ...
    Object invokeMethodBeforeResolving(Object self, String name, Object[] args) {
    ...
    void setThisMetaClass(MetaClass metaClass) {
    ...
    boolean wasHandled(Object result) {
        return !result.is(INVOKE_IMPLEMENTATION)
    }

    Object handleInvocation(Object self, Method thisMethod, Object[] args) {
