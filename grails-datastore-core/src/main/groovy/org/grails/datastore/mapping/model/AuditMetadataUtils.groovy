 ...
 */
@CompileStatic
class AuditMetadataUtils {

    private static final Logger LOG = LoggerFactory.getLogger(AuditMetadataUtils)
     ...
     */
    static AuditMetadataType getAuditMetadataType(PersistentProperty<?> persistentProperty, boolean cacheAnnotations) {
    ...
    private static AuditMetadataType detectAuditMetadataType(PersistentProperty<?> persistentProperty) {
        try {
            ...
            if (field != null) {
                for (Annotation annotation in field.getDeclaredAnnotations()) {
     ...
     */
    static boolean hasAuditMetadataAnnotation(PersistentProperty<?> persistentProperty, boolean cacheAnnotations) {
