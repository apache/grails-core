 ...
 */
@CompileStatic
class BeanFactoryValidatorRegistry implements ValidatorRegistry {

    private final BeanFactory beanFactory

    BeanFactoryValidatorRegistry(BeanFactory beanFactory) {
    ...
    Validator getValidator(PersistentEntity entity) {
        ...
        if (beanFactory.containsBean(validatorName)) {
            return beanFactory.getBean(validatorName, Validator)
        }
        return null
    }
