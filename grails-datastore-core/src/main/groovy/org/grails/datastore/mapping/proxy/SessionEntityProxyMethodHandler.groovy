...
@CompileStatic
@POJO
class SessionEntityProxyMethodHandler extends EntityProxyMethodHandler {

    private static final Logger LOG = LoggerFactory.getLogger(SessionEntityProxyMethodHandler)
    private final Session session
    private final Class cls
    private final Serializable id
    protected Object target

    SessionEntityProxyMethodHandler(Class proxyClass, Session session, Class cls, Serializable id) {
        super(proxyClass)
