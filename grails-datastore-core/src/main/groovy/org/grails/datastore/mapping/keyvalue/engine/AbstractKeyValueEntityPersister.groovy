...
@CompileStatic
abstract class AbstractKeyValueEntityPersister<T, K> extends NativeEntryEntityPersister<T, K> {
    ...
    protected AbstractKeyValueEntityPersister(MappingContext context, PersistentEntity entity,
        ...
        entityFamily = getFamily(entity, this.@classMapping)
    }
    ...
    protected String getNativePropertyKey(PersistentProperty prop) {
        PropertyMapping<KeyValue> pm = (PropertyMapping<KeyValue>) prop.getMapping()
        String propKey = null
