 ...
 */
@CompileStatic
abstract class Identity<T extends Property> extends AbstractPersistentProperty<T> {

    Identity(PersistentEntity owner, MappingContext context, PropertyDescriptor descriptor) {
        super(owner, context, descriptor)
    }

    Identity(PersistentEntity owner, MappingContext context, String name, @SuppressWarnings('rawtypes') Class type) {
