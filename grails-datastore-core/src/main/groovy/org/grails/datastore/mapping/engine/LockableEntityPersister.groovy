 ...
 */
@CompileStatic
abstract class LockableEntityPersister extends EntityPersister {

    public static int DEFAULT_TIMEOUT = 30

    LockableEntityPersister(MappingContext mappingContext, PersistentEntity entity,
     ...
     */
    abstract Object lock(Serializable id) throws CannotAcquireLockException
     ...
     */
    abstract Object lock(Serializable id, int timeout) throws CannotAcquireLockException
