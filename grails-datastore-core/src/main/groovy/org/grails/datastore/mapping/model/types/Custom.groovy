 ...
 */
@CompileStatic
abstract class Custom<T extends Property> extends AbstractPersistentProperty<T> {

    private CustomTypeMarshaller<?, ?, ?> customTypeMarshaller

    Custom(PersistentEntity owner, MappingContext context, PropertyDescriptor descriptor,
    ...
    CustomTypeMarshaller<Object, T, T> getCustomTypeMarshaller() {
