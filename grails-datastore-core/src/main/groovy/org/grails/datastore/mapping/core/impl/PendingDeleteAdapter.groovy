 ...
 */
@CompileStatic
abstract class PendingDeleteAdapter<E, K> extends PendingOperationAdapter<E, K> implements PendingDelete<E, K> {

    private boolean vetoed

    PendingDeleteAdapter(PersistentEntity entity, K nativeKey, E nativeEntry) {
