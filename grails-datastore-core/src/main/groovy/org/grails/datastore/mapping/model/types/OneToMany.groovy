...
abstract class OneToMany<T extends Property> extends ToMany<T> {
    ...
    OneToMany(PersistentEntity owner, MappingContext context, PropertyDescriptor descriptor) {
        super(owner, context, descriptor)
    }

    OneToMany(PersistentEntity owner, MappingContext context, String name, Class type) {
