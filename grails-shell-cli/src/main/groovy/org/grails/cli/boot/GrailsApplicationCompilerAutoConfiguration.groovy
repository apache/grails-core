 ...
 */
@CompileStatic
class GrailsApplicationCompilerAutoConfiguration extends CompilerAutoConfiguration {
    ...
    void applyDependencies(DependencyCustomizer dependencies) throws CompilationFailedException {
        ...
        if (lastMatch != null) {
            lastMatch.addAnnotation(createGrabAnnotation('org.apache.grails', 'grails-dependencies', Environment.getPackage().getImplementationVersion(), null, 'pom', true))
            lastMatch.addAnnotation(createGrabAnnotation('org.apache.grails', 'grails-web-boot', Environment.getPackage().getImplementationVersion(), null, null, true))
        }
    ...
    static AnnotationNode createGrabAnnotation(String group, String module,
                                                String version, String classifier, String type, boolean transitive) {
        AnnotationNode annotationNode = new AnnotationNode(new ClassNode(Grab))
    ...
    @Override
    void applyToMainClass(GroovyClassLoader loader, GroovyCompilerConfiguration configuration, GeneratorContext generatorContext, SourceUnit source, ClassNode classNode) throws CompilationFailedException {
    ...
    class GrailsDependencies implements DependencyManagement {
        ...
        GrailsDependencies(List<org.eclipse.aether.graph.Dependency> dependencies) {
