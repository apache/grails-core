...
class CommandRunner implements Iterable<org.springframework.boot.cli.command.Command> {
     ...
     */
    void addCommands(Iterable<org.springframework.boot.cli.command.Command> commands) {
     ...
     */
    void addCommand(org.springframework.boot.cli.command.Command command) {
     ...
     */
    void setOptionCommands(Class<?>... commandClasses) {
     ...
     */
    void setHiddenCommands(Class<?>... commandClasses) {
        Assert.notNull(commandClasses, 'CommandClasses must not be null')
     ...
     */
    boolean isOptionCommand(org.springframework.boot.cli.command.Command command) {
    ...
    @Override
    Iterator<org.springframework.boot.cli.command.Command> iterator() {
     ...
     */
    org.springframework.boot.cli.command.Command findCommand(String name) {
     ...
     */
    int runAndHandleErrors(String... args) {
    ...
    protected void showUsage() {
        ...
        for (Command command in this.commands) {
