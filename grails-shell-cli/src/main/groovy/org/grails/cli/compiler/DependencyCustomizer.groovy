...
class DependencyCustomizer {
     ...
     */
    DependencyCustomizer(GroovyClassLoader loader, ModuleNode moduleNode,
    ...
    String getVersion(String artifactId, String defaultVersion) {
     ...
     */
    DependencyCustomizer ifAnyMissingClasses(String... classNames) {
     ...
     * @return a nested {@link DependencyCustomizer}
     */
    DependencyCustomizer ifAllMissingClasses(String... classNames) {
        return new DependencyCustomizer(this) {
            @Override
            protected boolean canAdd() {
                for (String className in classNames) {
     ...
     * @return a nested {@link DependencyCustomizer}
     */
    DependencyCustomizer ifAllResourcesPresent(String... paths) {
        return new DependencyCustomizer(this) {
            @Override
            protected boolean canAdd() {
     ...
     * @return a nested {@link DependencyCustomizer}
     */
    DependencyCustomizer ifAnyResourcesPresent(String... paths) {
        return new DependencyCustomizer(this) {
            @Override
            protected boolean canAdd() {
                for (String path in paths) {
     ...
     */
    DependencyCustomizer add(String... modules) {
     ...
     * @return this {@link DependencyCustomizer} for continued use
     */
    DependencyCustomizer add(String module, boolean transitive) {
     ...
     * @return this {@link DependencyCustomizer} for continued use
     */
    DependencyCustomizer add(String module, String classifier, String type, boolean transitive) {
        if (canAdd()) {
     ...
     */
    DependencyResolutionContext getDependencyResolutionContext() {
