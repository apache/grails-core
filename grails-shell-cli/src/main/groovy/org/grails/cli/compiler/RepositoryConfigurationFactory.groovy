 ...
 */
@CompileStatic
final class RepositoryConfigurationFactory {
     ...
     */
    static List<RepositoryConfiguration> createDefaultRepositoryConfiguration() {
    ...
    private static void addActiveProfileRepositories(List<Profile> activeProfiles,
        ...
        for (Profile activeProfile in activeProfiles) {
            Interpolator interpolator = new RegexBasedInterpolator()
            interpolator.addValueSource(new PropertiesBasedValueSource(activeProfile.getProperties()))
            for (Repository repository in activeProfile.getRepositories()) {
