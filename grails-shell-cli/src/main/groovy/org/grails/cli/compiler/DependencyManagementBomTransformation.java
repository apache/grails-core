 ...
 * {@link org.grails.cli.groovy.DependencyManagementBom} annotations.
 *
...
public class DependencyManagementBomTransformation extends AnnotatedNodeASTTransformation {
    ...
    private static final Set<String> DEPENDENCY_MANAGEMENT_BOM_ANNOTATION_NAMES = Set.of(DependencyManagementBom.class.getName(), DependencyManagementBom.class.getSimpleName());
