...
The `merge` method is equivalent to the Hibernate https://javadoc.io/doc/org.hibernate/hibernate-core/5.6.5.Final/org/hibernate/Session.html#merge(java/lang/Object).html[merge] method.
