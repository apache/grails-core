...
Equivalent to the Hibernate https://javadoc.io/doc/org.hibernate/hibernate-core/5.6.5.Final/org/hibernate/Session.html#refresh-java.lang.Object-[refresh] method.
