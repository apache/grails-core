...
| `legacy-commands-plugin` | A Grails 8 plugin whose legacy commands are recompiled under Groovy 6. |
...
substitute `org.apache.grails:grails-core` for this repository's Groovy 6 project, which is exactly
