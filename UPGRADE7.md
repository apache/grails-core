...
- The amount of boilerplate required in gradle files has been reduced:  
  - When `org.apache.grails.gradle.grails-plugin`, previously `org.grails.grails-plugin`, gradle plugin is applied, the bootJar task is disabled by default.  No more needing to explicitly set it to false!
