...
class EntityFetchOptions {
     ...
     */
    Map<String, Map> getFetchArgument(Set<String> properties) {
    ...
    Map<String, Map> getFetchArgument(DataFetchingEnvironment environment) {
     ...
     * @return The fetch argument
     */
    Map<String, Map> getFetchArgument(DataFetchingEnvironment environment, boolean skipCollections) {
